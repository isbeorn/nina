...
namespace NINA.Equipment.Equipment.MyFilterWheel {
    ...
    internal class IndiFilterWheel : IndiDevice<IINDIFilterWheel>, IFilterWheel, IDisposable {

        public IndiFilterWheel(INDIDeviceInfo info, IProfileService profileService) : base(info) {
        ...
        protected override IINDIFilterWheel GetInstance() {
            return device ??= new INDIFilterWheel(_device);
        }
    }
}
