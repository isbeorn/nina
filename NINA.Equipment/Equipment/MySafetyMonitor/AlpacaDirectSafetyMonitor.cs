...
namespace NINA.Equipment.Equipment.MySafetyMonitor {
    internal class AlpacaDirectSafetyMonitor : ISafetyMonitor, INotifyPropertyChanged {
        ...
        private AscomSafetyMonitor device;

        private void SetDevice(AscomSafetyMonitor newDevice) {
        ...
        public AlpacaDirectSafetyMonitor(IProfileService profileService) {
        ...
        public string DisplayName => (device?.Name ?? "Alpaca Safety Monitor - Static IP") + $" @ {settings.IpAddress} #{settings.DeviceNumber}";
        ...
        public async Task<bool> Connect(CancellationToken token) {
            ...
            SetDevice(new AscomSafetyMonitor(meta));
