...
namespace NINA.CustomControlLibrary {
    ...
    public class LoadingControl : UserControl {
        ...
        private static Geometry CreateDefaultLoadingImage() {
            Geometry geometry = Geometry.Parse(DefaultLoadingImageData);
            geometry.Freeze();
            return geometry;
        }
        ...
        public static readonly DependencyProperty LoadingImageProperty =
           DependencyProperty.Register(nameof(LoadingImage), typeof(Geometry), typeof(LoadingControl), new UIPropertyMetadata(DefaultLoadingImage));
        ...
        public static readonly DependencyProperty LoadingImageBrushProperty =
           DependencyProperty.Register(nameof(LoadingImageBrush), typeof(Brush), typeof(LoadingControl), new UIPropertyMetadata(DefaultLoadingImageBrush));
