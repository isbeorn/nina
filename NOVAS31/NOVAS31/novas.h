...
*/
   ...
   EXPORT short int app_star (double jd_tt, cat_entry *star,
                       short int accuracy,

                       double *ra, double *dec);

   EXPORT short int virtual_star (double jd_tt, cat_entry *star,
                           short int accuracy,

                           double *ra, double *dec);

   EXPORT short int astro_star (double jd_tt, cat_entry *star,
                         short int accuracy,

                         double *ra, double *dec);

   EXPORT short int app_planet (double jd_tt, object *ss_body,
                         short int accuracy,

                         double *ra, double *dec, double *dis);

   EXPORT short int virtual_planet (double jd_tt, object *ss_body,
                             short int accuracy,

                             double *ra, double *dec, double *dis);

   EXPORT short int astro_planet (double jd_tt, object *ss_body,
                           short int accuracy,

                           double *ra, double *dec, double *dis);

   EXPORT short int topo_star (double jd_tt, double delta_t, cat_entry *star,
                        on_surface *position, short int accuracy,

                        double *ra, double *dec);

   EXPORT short int local_star (double jd_tt, double delta_t, cat_entry *star,
                         on_surface *position, short int accuracy,

                         double *ra, double *dec);

   EXPORT short int topo_planet (double jd_tt, object *ss_body, double delta_t,
                          on_surface *position, short int accuracy,

                          double *ra, double *dec, double *dis);

   EXPORT short int local_planet (double jd_tt, object *ss_body,
                           double delta_t, on_surface *position,
                           short int accuracy,

                           double *ra, double *dec, double *dis);

   EXPORT short int mean_star (double jd_tt, double ra, double dec,
                        short int accuracy,

                        double *ira, double *idec);

   EXPORT short int place (double jd_tt, object *cel_object,
                    observer *location, double delta_t,
                    short int coord_sys, short int accuracy,

                    sky_pos *output);

   EXPORT void equ2gal (double rai, double deci,

                 double *glon, double *glat);

   EXPORT short int equ2ecl (double jd_tt, short int coord_sys,
                      short int accuracy, double ra, double dec,

                      double *elon, double *elat);

   EXPORT short int equ2ecl_vec (double jd_tt, short int coord_sys,
                          short int accuracy, double *pos1,

                          double *pos2);

   EXPORT short int ecl2equ_vec (double jd_tt, short int coord_sys,
                          short int accuracy, double *pos1,

                          double *pos2);

   EXPORT void equ2hor (double jd_ut1, double delta_t, short int accuracy,
   ...
   EXPORT short int gcrs2equ (double jd_tt, short int coord_sys,
                       short int accuracy, double rag, double decg,

                       double *ra, double *dec);

   EXPORT short int sidereal_time (double jd_high, double jd_low,
                            double delta_t, short int gst_type,
                            short int method, short int accuracy,

                            double *gst);

   EXPORT double era (double jd_high, double jd_low);

   EXPORT short int ter2cel (double jd_ut_high, double jd_ut_low,
   ...
   EXPORT short int cel2ter (double jd_ut_high, double jd_ut_low,
                      double delta_t, short int method,
   ...
   EXPORT void spin (double angle, double *pos1,

              double *pos2);

   EXPORT void wobble (double tjd, short int direction, double xp, double yp,
                double *pos1,

                double *pos2);

   EXPORT void terra (on_surface *location, double st,

               double *pos, double *vel);

   EXPORT void e_tilt (double jd_tdb, short int accuracy,

                double *mobl, double *tobl, double *ee, double *dpsi,
                double *deps);

   EXPORT short int cel_pole (double tjd, short int type, double dpole1,
                       double dpole2);

   EXPORT double ee_ct (double jd_high, double jd_low, short int accuracy);

   EXPORT void frame_tie (double *pos1, short int direction,

                   double *pos2);

   EXPORT void proper_motion (double jd_tdb1, double *pos, double *vel,
                       double jd_tdb2,

                       double *pos2);

   EXPORT void bary2obs (double *pos, double *pos_obs,

                  double *pos2, double *lighttime);

   EXPORT short int geo_posvel (double jd_tt, double delta_t,
                         short int accuracy, observer *obs,

                         double *pos, double *vel);

   EXPORT short int light_time (double jd_tdb, object *ss_object,
                         double pos_obs[3], double tlight0,
                         short int accuracy,

                         double pos[3], double *tlight);

   EXPORT double d_light (double *pos1, double *pos_obs);

   EXPORT short int grav_def (double jd_tdb, short int loc_code,
                       short int accuracy, double *pos1, double *pos_obs,

                       double *pos2);

   EXPORT void grav_vec (double *pos1, double *pos_obs, double *pos_body,
                  double rmass,

                  double *pos2);

   EXPORT void aberration (double *pos, double *ve, double lighttime,

                    double *pos2);

   EXPORT void rad_vel (object *cel_object, double *pos, double *vel,
                 double *vel_obs, double d_obs_geo, double d_obs_sun,
                 double d_obj_sun,

                 double *rv);

   EXPORT short int precession (double jd_tdb1, double *pos1, double jd_tdb2,

                         double *pos2);

   EXPORT void nutation (double jd_tdb, short int direction, short int accuracy,
                  double *pos,

                  double *pos2);

   EXPORT void nutation_angles (double t, short int accuracy,
   ...
   EXPORT double mean_obliq (double jd_tdb);
   ...
   EXPORT void tdb2tt (double tdb_jd,

                double *tt_jd, double *secdiff);

   EXPORT short int cio_ra (double jd_tt, short int accuracy,

                     double *ra_cio);

   EXPORT short int cio_location (double jd_tdb, short int accuracy,

                           double *ra_cio, short int *ref_sys);

   EXPORT short int cio_basis (double jd_tdb, double ra_cio, short int ref_sys,
                        short int accuracy,

                        double *x, double *y, double *z);

   EXPORT short int cio_array (double jd_tdb, long int n_pts,

                        ra_of_cio *cio);

   EXPORT double ira_equinox (double jd_tdb, short int equinox,
                       short int accuracy);

   EXPORT short int ephemeris (double jd[2], object *cel_obj, short int origin,
                        short int accuracy,
   ...
   EXPORT short int transform_cat (short int option, double date_incat,
                            cat_entry *incat, double date_newcat,
                            char newcat_id[SIZE_OF_CAT_NAME],

                            cat_entry *newcat);

   EXPORT void limb_angle (double pos_obj[3], double pos_obs[3],

                    double *limb_ang, double *nadir_ang);

   EXPORT double refract (on_surface *location, short int ref_option,
                   double zd_obs);
   ...
   EXPORT double norm_ang (double angle);

   EXPORT short int make_cat_entry (char star_name[SIZE_OF_OBJ_NAME],
                             char catalog[SIZE_OF_CAT_NAME],
   ...
   EXPORT short int make_object (short int type, short int number,
                          char name[SIZE_OF_OBJ_NAME],
                          cat_entry *star_data,

                          object *cel_obj);

   EXPORT short int make_observer (short int where, on_surface *obs_surface,
                            in_space *obs_space,

                            observer *obs);

   EXPORT void make_observer_at_geocenter (

                                 observer *obs_at_geocenter);

   EXPORT void make_observer_on_surface (double latitude, double longitude,
                                  double height, double temperature,
                                  double pressure,

                                  observer *obs_on_surface);

   EXPORT void make_observer_in_space (double sc_pos[3], double sc_vel[3],

                                observer *obs_in_space);

   EXPORT void make_on_surface (double latitude, double longitude,
                         double height,
                         double temperature, double pressure,

                         on_surface *obs_surface);

   EXPORT void make_in_space (double sc_pos[3], double sc_vel[3],
