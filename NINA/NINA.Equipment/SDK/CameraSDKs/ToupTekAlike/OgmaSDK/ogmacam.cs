...
public class Ogmacam : IDisposable {
    ...
    */
    ...
    public static Ogmacam Open(string camId) {
        SafeCamHandle tmphandle = Ogmacam_Open(camId);
    ...
    */
    /*
        ...
        etc
    */
    public static Ogmacam OpenByIndex(uint index) {
        SafeCamHandle tmphandle = Ogmacam_OpenByIndex(index);
        if (tmphandle == null || tmphandle.IsInvalid || tmphandle.IsClosed)
            return null;
        return new Ogmacam(tmphandle);
    }
    ...
    public ushort Revision {
        get {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return rev;
            Ogmacam_get_Revision(handle_, out rev);
            return rev;
        }
    }
    ...
    public string SerialNumber {
        get {
            ...
            if (Ogmacam_get_SerialNumber(handle_, ptr) >= 0)
    ...
    public string FwVersion {
        get {
            ...
            if (Ogmacam_get_FwVersion(handle_, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public string HwVersion {
        get {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return str;
            IntPtr ptr = Marshal.AllocHGlobal(32);
            if (Ogmacam_get_HwVersion(handle_, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public string ProductionDate {
        get {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return str;
            IntPtr ptr = Marshal.AllocHGlobal(32);
            if (Ogmacam_get_ProductionDate(handle_, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public string FpgaVersion {
        get {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return str;
            IntPtr ptr = Marshal.AllocHGlobal(32);
            if (Ogmacam_get_FpgaVersion(handle_, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public uint Field {
        get {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return 0;
            return (uint)Ogmacam_get_Field(handle_);
        }
    }
    ...
    public bool StartPullModeWithCallback(DelegateEventCallback funEvent) {
        ...
        if (funEvent != null) {
            ...
            return CheckHResult(Ogmacam_StartPullModeWithCallback(handle_, null, IntPtr.Zero));
        }
    }
    ...
    */
    ...
    public bool Pause(bool bPause) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_Pause(handle_, bPause ? 1 : 0));
    }
    ...
    */
    ...
    public bool get_AutoExpoEnable(out bool bAutoExposure) {
        ...
        int iEnable = 0;
        if (!CheckHResult(Ogmacam_get_AutoExpoEnable(handle_, out iEnable)))
            return false;
    ...
    public bool put_AutoExpoEnable(bool bAutoExposure) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_AutoExpoEnable(handle_, bAutoExposure ? 1 : 0));
    }
    ...
    public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow, ushort[] aHigh) {
        ...
        return CheckHResult(Ogmacam_put_LevelRangeV2(handle_, mode, ref rc, aLow, aHigh));
    }
    ...
    public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight, ushort[] aLow, ushort[] aHigh) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        RECT rc = new RECT();
        if (!CheckHResult(Ogmacam_get_LevelRangeV2(handle_, out mode, out rc, aLow, aHigh)))
            return false;
        roiX = rc.left;
        roiY = rc.top;
    ...
    public bool get_Chrome(out bool bChrome)    /* monochromatic mode */
    {
        ...
        int iEnable = 0;
        if (!CheckHResult(Ogmacam_get_Chrome(handle_, out iEnable)))
            return false;
    ...
    public bool put_Chrome(bool bChrome) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_Chrome(handle_, bChrome ? 1 : 0));
    }
    ...
    public bool get_VFlip(out bool bVFlip) /* vertical flip */
    {
        ...
        int iVFlip = 0;
        if (!CheckHResult(Ogmacam_get_VFlip(handle_, out iVFlip)))
            return false;
    ...
    public bool put_VFlip(bool bVFlip) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_VFlip(handle_, bVFlip ? 1 : 0));
    }
    ...
    public bool get_HFlip(out bool bHFlip) {
        ...
        int iHFlip = 0;
        if (!CheckHResult(Ogmacam_get_HFlip(handle_, out iHFlip)))
            return false;
    ...
    public bool put_HFlip(bool bHFlip)  /* horizontal flip */
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_HFlip(handle_, bHFlip ? 1 : 0));
    }
    ...
    public bool get_Negative(out bool bNegative) {
        ...
        int iNegative = 0;
        if (!CheckHResult(Ogmacam_get_Negative(handle_, out iNegative)))
            return false;
    ...
    public bool put_Negative(bool bNegative) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_Negative(handle_, bNegative ? 1 : 0));
    }
    ...
    */
    ...
    public bool put_Mode(bool bSkip) /* skip or bin */
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_Mode(handle_, bSkip ? 1 : 0));
    }
    ...
    public bool get_Mode(out bool bSkip) {
        ...
        int iSkip = 0;
        if (!CheckHResult(Ogmacam_get_Mode(handle_, out iSkip)))
            return false;
    ...
    public bool put_AWBAuxRect(int X, int Y, int Width, int Height) {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Ogmacam_put_AWBAuxRect(handle_, ref rc));
    }
    ...
    public bool get_AWBAuxRect(out int X, out int Y, out int Width, out int Height) {
        ...
        RECT rc = new RECT();
        if (!CheckHResult(Ogmacam_get_AWBAuxRect(handle_, out rc)))
            return false;
    ...
    public bool put_AEAuxRect(int X, int Y, int Width, int Height) {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Ogmacam_put_AEAuxRect(handle_, ref rc));
    }
    ...
    public bool get_AEAuxRect(out int X, out int Y, out int Width, out int Height) {
        ...
        RECT rc = new RECT();
        if (!CheckHResult(Ogmacam_get_AEAuxRect(handle_, out rc)))
            return false;
    ...
    public bool put_ABBAuxRect(int X, int Y, int Width, int Height) {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Ogmacam_put_ABBAuxRect(handle_, ref rc));
    }
    ...
    public bool get_ABBAuxRect(out int X, out int Y, out int Width, out int Height) {
        ...
        RECT rc = new RECT();
        if (!CheckHResult(Ogmacam_get_ABBAuxRect(handle_, out rc)))
            return false;
    ...
    public bool get_StillResolution(uint nResolutionIndex, out int pWidth, out int pHeight) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_get_StillResolution(handle_, nResolutionIndex, out pWidth, out pHeight));
    }

    public bool put_VignetEnable(bool bEnable) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_VignetEnable(handle_, bEnable ? 1 : 0));
    }
    ...
    public bool get_VignetEnable(out bool bEnable) {
        ...
        int iEanble = 0;
        if (!CheckHResult(Ogmacam_get_VignetEnable(handle_, out iEanble)))
            return false;
    ...
    */
    public bool put_Binning(string Value, string Method) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_Binning(handle_, Value, Method));
    }
    ...
    public bool get_Binning(out string Value, out string Method) {
        ...
        bool ret = CheckHResult(Ogmacam_get_Binning(handle_, out valuePtr, out methodPtr));
        if (ret) {
    ...
    public int get_BinningNumber() {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return 0;
        return Ogmacam_get_BinningNumber(handle_);
    }
    ...
    public bool get_BinningValue(uint index, out string Value) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        IntPtr valuePtr = new IntPtr(0);
        bool ret = CheckHResult(Ogmacam_get_BinningValue(handle_, index, out valuePtr));
        if (ret)
            Value = Marshal.PtrToStringAnsi(valuePtr);
        return ret;
    }
    ...
    public bool get_BinningMethod(uint index, out string Method) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        IntPtr methodPtr = new IntPtr(0);
        bool ret = CheckHResult(Ogmacam_get_BinningMethod(handle_, index, out methodPtr));
        if (ret)
            Method = Marshal.PtrToStringAnsi(methodPtr);
        return ret;
    }
    ...
    public bool put_SelfTrigger(ref SelfTrigger pSt) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_put_SelfTrigger(handle_, ref pSt));
    }

    public bool get_SelfTrigger(ref SelfTrigger pSt) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_get_SelfTrigger(handle_, ref pSt));
    }
    ...
    */
    ...
    public bool IoControl(uint ioLine, eIoControType eType, int outVal, out int inVal) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_IoControl(handle_, ioLine, eType, outVal, out inVal));
    }
    ...
    public bool get_LensInfo(ref LensInfo pInfo) {
        ...
        if (!CheckHResult(Ogmacam_get_LensInfo(handle_, p))) {
    ...
    public bool get_AFState(ref AFState pState) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_get_AFState(handle_, ref pState));
    }
    ...
    public bool get_FocusMotor(out FocusMotor pFocusMotor) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Ogmacam_get_FocusMotor(handle_, out pFocusMotor));
    }
    ...
    */
    public static int Update(string camId, string filePath, DelegateProgress funProgress) {
        ...
        int ret = Ogmacam_Update(camId, filePath, pProgress, id);
    ...
    /*
        the object of Ogmacam must be obtained by static mothod Open or OpenByIndex, it cannot be obtained by obj = new Ogmacam (The constructor is private on purpose)
    */
    private Ogmacam(SafeCamHandle h) {
        handle_ = h;
    ...
    public class SafeCamHandle : SafeHandleZeroOrMinusOneIsInvalid {
        ...
        private static extern void Ogmacam_Close(IntPtr h);
...
#if LINUX
    private const string dll = "libogmacam.so";
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern IntPtr Ogmacam_Version();
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern uint Ogmacam_EnumWithName(IntPtr ptr);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_Pause(SafeCamHandle h, int bPause);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_Snap(SafeCamHandle h, uint nResolutionIndex);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_SnapN(SafeCamHandle h, uint nResolutionIndex, uint nNumber);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_SnapR(SafeCamHandle h, uint nResolutionIndex, uint nNumber);
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Size(SafeCamHandle h, out int nWidth, out int nHeight);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_eSize(SafeCamHandle h, uint nResolutionIndex);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_eSize(SafeCamHandle h, out uint nResolutionIndex);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_FinalSize(SafeCamHandle h, out int nWidth, out int nHeight);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern uint Ogmacam_get_ResolutionNumber(SafeCamHandle h);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Resolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth, out int pHeight);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_ResolutionRatio(SafeCamHandle h, uint nResolutionIndex, out int pNumerator, out int pDenominator);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern uint Ogmacam_get_Field(SafeCamHandle h);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_RawFormat(SafeCamHandle h, out uint nFourCC, out uint bitdepth);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_RealTime(SafeCamHandle h, int val);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_RealTime(SafeCamHandle h, out int val);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_Flush(SafeCamHandle h);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Temperature(SafeCamHandle h, out short pTemperature);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Temperature(SafeCamHandle h, short nTemperature);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Roi(SafeCamHandle h, out uint pxOffset, out uint pyOffset, out uint pxWidth, out uint pyHeight);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_AutoExpoEnable(SafeCamHandle h, out int bAutoExposure);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AutoExpoEnable(SafeCamHandle h, int bAutoExposure);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_AutoExpoTarget(SafeCamHandle h, out ushort Target);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AutoExpoTarget(SafeCamHandle h, ushort Target);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AutoExpoRange(SafeCamHandle h, uint maxTime, uint minTime, ushort maxGain, ushort minGain);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_AutoExpoRange(SafeCamHandle h, out uint maxTime, out uint minTime, out ushort maxGain, out ushort minGain);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_MaxAutoExpoTimeAGain(SafeCamHandle h, uint maxTime, ushort maxGain);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_MaxAutoExpoTimeAGain(SafeCamHandle h, out uint maxTime, out ushort maxGain);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_MinAutoExpoTimeAGain(SafeCamHandle h, uint minTime, ushort minGain);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_MinAutoExpoTimeAGain(SafeCamHandle h, out uint minTime, out ushort minGain);
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_RealExpoTime(SafeCamHandle h, out uint Time)/* actual exposure time */;
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_ExpTimeRange(SafeCamHandle h, out uint nMin, out uint nMax, out uint nDef);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_ExpoAGain(SafeCamHandle h, out ushort Gain);/* percent, such as 300 */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_ExpoAGain(SafeCamHandle h, ushort Gain);/* percent */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_ExpoAGainRange(SafeCamHandle h, out ushort nMin, out ushort nMax, out ushort nDef);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_LevelRange(SafeCamHandle h, [In] ushort[] aLow, [In] ushort[] aHigh);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_LevelRange(SafeCamHandle h, [Out] ushort[] aLow, [Out] ushort[] aHigh);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_LevelRangeV2(SafeCamHandle h, ushort mode, ref RECT roiRect, [In] ushort[] aLow, [In] ushort[] aHigh);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_LevelRangeV2(SafeCamHandle h, out ushort mode, out RECT pRoiRect, [Out] ushort[] aLow, [Out] ushort[] aHigh);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Hue(SafeCamHandle h, int Hue);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Hue(SafeCamHandle h, out int Hue);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Saturation(SafeCamHandle h, int Saturation);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Saturation(SafeCamHandle h, out int Saturation);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Brightness(SafeCamHandle h, int Brightness);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Brightness(SafeCamHandle h, out int Brightness);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Contrast(SafeCamHandle h, out int Contrast);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Contrast(SafeCamHandle h, int Contrast);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Gamma(SafeCamHandle h, out int Gamma);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Gamma(SafeCamHandle h, int Gamma);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Chrome(SafeCamHandle h, out int bChrome);    /* monochromatic mode */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Chrome(SafeCamHandle h, int bChrome);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_VFlip(SafeCamHandle h, out int bVFlip);  /* vertical flip */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_VFlip(SafeCamHandle h, int bVFlip);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_HFlip(SafeCamHandle h, out int bHFlip);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_HFlip(SafeCamHandle h, int bHFlip);  /* horizontal flip */

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Negative(SafeCamHandle h, out int bNegative);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Negative(SafeCamHandle h, int bNegative);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Speed(SafeCamHandle h, ushort nSpeed);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Speed(SafeCamHandle h, out ushort pSpeed);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_HZ(SafeCamHandle h, int nHZ);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_HZ(SafeCamHandle h, out int nHZ);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Mode(SafeCamHandle h, int bSkip); /* skip or bin */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Mode(SafeCamHandle h, out int bSkip);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_TempTint(SafeCamHandle h, int nTemp, int nTint);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_TempTint(SafeCamHandle h, out int nTemp, out int nTint);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_WhiteBalanceGain(SafeCamHandle h, [In] int[] aGain);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_WhiteBalanceGain(SafeCamHandle h, [Out] int[] aGain);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_BlackBalance(SafeCamHandle h, [In] ushort[] aSub);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_BlackBalance(SafeCamHandle h, [Out] ushort[] aSub);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AWBAuxRect(SafeCamHandle h, ref RECT pAuxRect);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_AWBAuxRect(SafeCamHandle h, out RECT pAuxRect);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AEAuxRect(SafeCamHandle h, ref RECT pAuxRect);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_AEAuxRect(SafeCamHandle h, out RECT pAuxRect);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_ABBAuxRect(SafeCamHandle h, ref RECT pAuxRect);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_ABBAuxRect(SafeCamHandle h, out RECT pAuxRect);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_MonoMode(SafeCamHandle h);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern uint Ogmacam_get_StillResolutionNumber(SafeCamHandle h);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_StillResolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth, out int pHeight);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Revision(SafeCamHandle h, out ushort pRevision);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_SerialNumber(SafeCamHandle h, IntPtr sn);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_FwVersion(SafeCamHandle h, IntPtr fwver);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_HwVersion(SafeCamHandle h, IntPtr hwver);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_FpgaVersion(SafeCamHandle h, IntPtr fpgaver);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_ProductionDate(SafeCamHandle h, IntPtr pdate);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_PixelSize(SafeCamHandle h, uint nResolutionIndex, out float x, out float y);
    ...
    */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_VignetEnable(SafeCamHandle h, int bEnable);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_VignetEnable(SafeCamHandle h, out int bEnable);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_VignetAmountInt(SafeCamHandle h, int nAmount);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_VignetAmountInt(SafeCamHandle h, out int nAmount);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_VignetMidPointInt(SafeCamHandle h, int nMidPoint);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_VignetMidPointInt(SafeCamHandle h, out int nMidPoint);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_AwbOnce(SafeCamHandle h, IntPtr funTT, IntPtr ctxTT);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_AwbInit(SafeCamHandle h, IntPtr funWB, IntPtr ctxWB);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_LevelRangeAuto(SafeCamHandle h);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACKV1 funHistogramV1, IntPtr ctxHistogramV1);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_GetHistogramV2(SafeCamHandle h, HISTOGRAM_CALLBACKV2 funHistogramV2, IntPtr ctxHistogramV2);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_AbbOnce(SafeCamHandle h, IntPtr funBB, IntPtr ctxBB);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_LEDState(SafeCamHandle h, ushort iLed, ushort iState, ushort iPeriod);
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_read_Pipe(SafeCamHandle h, uint pipeId, IntPtr pBuffer, uint nBufferLen);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_feed_Pipe(SafeCamHandle h, uint pipeId);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_write_UART(SafeCamHandle h, IntPtr pBuffer, uint nBufferLen);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_read_UART(SafeCamHandle h, IntPtr pBuffer, uint nBufferLen);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Option(SafeCamHandle h, eOPTION iOption, int iValue);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Option(SafeCamHandle h, eOPTION iOption, out int iValue);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_PixelFormatSupport(SafeCamHandle h, sbyte cmd, out int iValue);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern IntPtr Ogmacam_get_PixelFormatName(ePIXELFORMAT val);
    ...
    */
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Binning(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string Value, [MarshalAs(UnmanagedType.LPStr)] string Method);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_Binning(SafeCamHandle h, out IntPtr Value, out IntPtr Method);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_BinningNumber(SafeCamHandle h);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_BinningValue(SafeCamHandle h, uint index, out IntPtr Value);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_BinningMethod(SafeCamHandle h, uint index, out IntPtr Value);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_SelfTrigger(SafeCamHandle h, ref SelfTrigger pSt);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_SelfTrigger(SafeCamHandle h, ref SelfTrigger pSt);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Linear(SafeCamHandle h, byte[] v8, ushort[] v16);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_Curve(SafeCamHandle h, byte[] v8, ushort[] v16);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_ColorMatrix(SafeCamHandle h, double[] v);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_InitWBGain(SafeCamHandle h, ushort[] v);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_FrameRate(SafeCamHandle h, out uint nFrame, out uint nTime, out uint nTotalFrame);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_FfcOnce(SafeCamHandle h);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_DfcOnce(SafeCamHandle h);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_IoControl(SafeCamHandle h, uint ioLine, eIoControType eType, int outVal, out int inVal);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_AAF(SafeCamHandle h, eAAF action, int outVal, out int inVal);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_LensInfo(SafeCamHandle h, IntPtr pInfo);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_AFState(SafeCamHandle h, ref AFState pState);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AFMode(SafeCamHandle h, eAFMode mode);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AFRoi(SafeCamHandle h, uint xOffset, uint yOffset, uint xWidth, uint yHeight);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AFAperture(SafeCamHandle h, int iAperture);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_put_AFFMPos(SafeCamHandle h, int iFMPos);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_get_FocusMotor(SafeCamHandle h, out FocusMotor pFocusMotor);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern double Ogmacam_calc_ClarityFactor(IntPtr pImageData, int bits, uint nImgWidth, uint nImgHeight);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern double Ogmacam_calc_ClarityFactorV2(IntPtr pImageData, int bits, uint nImgWidth, uint nImgHeight, uint xOffset, uint yOffset, uint xWidth, uint yHeight);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern void Ogmacam_deBayerV2(uint nBayer, int nW, int nH, IntPtr input, IntPtr output, byte nBitDepth, byte nBitCount);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_Replug([MarshalAs(ut)] string camId);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_Update([MarshalAs(ut)] string camId, [MarshalAs(ut)] string filePath, PROGRESS_CALLBACK funProgress, IntPtr ctxProgress);

    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Ogmacam_GigeEnable(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug);
