...
namespace MallinCam {
    ...
    Version: 57.27650.20250209
        ...
        We use P/Invoke to call into the mallincam.dll API, the c# class Mallincam is a thin wrapper class to the native api of mallincam.dll.
        So the manual en.html(English) and hans.html(Simplified Chinese) are also applicable for programming with mallincam.cs.
    ...
    */
    ...
    public static extern void memcpy(IntPtr dest, IntPtr src, IntPtr count);
        ...
        /* enumerate Mallincam cameras that are currently connected to computer */
        public static DeviceV2[] EnumV2() {
            IntPtr p = Marshal.AllocHGlobal(512 * 128);
            return Ptr2Device(p, Mallincam_EnumV2(p));
        }

        public static DeviceV2[] EnumWithName() {
            IntPtr p = Marshal.AllocHGlobal(512 * 128);
            return Ptr2Device(p, Mallincam_EnumWithName(p));
        }
        ...
        public static int GigeEnable(DelegateHotplug funHotplug) {
            ...
            return Mallincam_GigeEnable(pHotplug, id);
        }
        ...
        /*
            the object of Mallincam must be obtained by static mothod Open or OpenByIndex, it cannot be obtained by obj = new Mallincam (The constructor is private on purpose)
        */
        // camId: enumerated by EnumV2, null means the first enumerated camera
        public static Mallincam Open(string camId) {
            SafeCamHandle tmphandle = Mallincam_Open(camId);
            if (tmphandle == null || tmphandle.IsInvalid || tmphandle.IsClosed)
                return null;
            return new Mallincam(tmphandle);
        }
        ...
        */
        /*
            ...
            etc
        */
        public static Mallincam OpenByIndex(uint index) {
            SafeCamHandle tmphandle = Mallincam_OpenByIndex(index);
            if (tmphandle == null || tmphandle.IsInvalid || tmphandle.IsClosed)
                return null;
            return new Mallincam(tmphandle);
        }
        ...
        public uint ResolutionNumber {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Mallincam_get_ResolutionNumber(handle_);
            }
        }
        ...
        public uint StillResolutionNumber {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Mallincam_get_StillResolutionNumber(handle_);
            }
        }
        ...
        public bool MonoMode {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return false;
                return (0 == Mallincam_get_MonoMode(handle_));
            }
        }
        ...
        public uint MaxSpeed {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Mallincam_get_MaxSpeed(handle_);
            }
        }
        ...
        public uint MaxBitDepth {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Mallincam_get_MaxBitDepth(handle_);
            }
        }
        ...
        public uint FanMaxSpeed {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Mallincam_get_FanMaxSpeed(handle_);
            }
        }
        ...
        public short TecTargetMax {
            get {
                if (handle_ != null && !handle_.IsInvalid && !handle_.IsClosed) {
                    int range = 0;
                    if (CheckHResult(Mallincam_get_Option(handle_, eOPTION.OPTION_TECTARGET_RANGE, out range)))
        ...
        public ushort Revision {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return rev;
                Mallincam_get_Revision(handle_, out rev);
                return rev;
            }
        }
        ...
        public string SerialNumber {
            get {
                ...
                if (Mallincam_get_SerialNumber(handle_, ptr) >= 0)
        ...
        public string FwVersion {
            get {
                ...
                if (Mallincam_get_FwVersion(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public string HwVersion {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return str;
                IntPtr ptr = Marshal.AllocHGlobal(32);
                if (Mallincam_get_HwVersion(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public string ProductionDate {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return str;
                IntPtr ptr = Marshal.AllocHGlobal(32);
                if (Mallincam_get_ProductionDate(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public string FpgaVersion {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return str;
                IntPtr ptr = Marshal.AllocHGlobal(32);
                if (Mallincam_get_FpgaVersion(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public uint Field {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return (uint)Mallincam_get_Field(handle_);
            }
        }
        ...
        public bool StartPullModeWithCallback(DelegateEventCallback funEvent) {
            ...
            if (funEvent != null) {
                ...
                return CheckHResult(Mallincam_StartPullModeWithCallback(handle_, pEvent_, id_));
            } else {
                return CheckHResult(Mallincam_StartPullModeWithCallback(handle_, null, IntPtr.Zero));
            }
        }
        ...
        public bool PullImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Mallincam_PullImage(handle_, pImageData, bits, out pnWidth, out pnHeight));
        }
        ...
        public bool PullImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Mallincam_PullImageV2(handle_, pImageData, bits, out pInfo));
        }
        ...
        public bool PullStillImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Mallincam_PullStillImage(handle_, pImageData, bits, out pnWidth, out pnHeight));
        }
        ...
        public bool PullStillImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Mallincam_PullStillImageV2(handle_, pImageData, bits, out pInfo));
        }
        ...
        */
        public bool PullImage(IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo) {
            ...
            return CheckHResult(Mallincam_PullImageV4(handle_, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool PullImageV3(IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo) {
            ...
            return CheckHResult(Mallincam_PullImageV3(handle_, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool WaitImage(uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo) {
            ...
            return CheckHResult(Mallincam_WaitImageV4(handle_, nWaitMS, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool WaitImageV3(uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo) {
            ...
            return CheckHResult(Mallincam_WaitImageV3(handle_, nWaitMS, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool PullImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Mallincam_PullImageWithRowPitch(handle_, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
        }
        ...
        public bool PullImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Mallincam_PullImageWithRowPitchV2(handle_, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool PullStillImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Mallincam_PullStillImageWithRowPitch(handle_, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
        }
        ...
        public bool PullStillImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Mallincam_PullStillImageWithRowPitchV2(handle_, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool StartPushModeV4(DelegateDataCallbackV4 funData, DelegateEventCallback funEvent) {
            ...
            pEvent_ = new EVENT_CALLBACK(EventCallback);
            return CheckHResult(Mallincam_StartPushModeV4(handle_, pDataV4_, id_, pEvent_, id_));
        }
        ...
        public bool StartPushModeV3(DelegateDataCallbackV3 funData, DelegateEventCallback funEvent) {
            ...
            pEvent_ = new EVENT_CALLBACK(EventCallback);
            return CheckHResult(Mallincam_StartPushModeV3(handle_, pDataV3_, id_, pEvent_, id_));
        }

        public bool Stop() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_Stop(handle_));
        }
        ...
        public bool SnapN(uint nResolutionIndex, uint nNumber) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_SnapN(handle_, nResolutionIndex, nNumber));
        }
        ...
        public bool SnapR(uint nResolutionIndex, uint nNumber) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_SnapR(handle_, nResolutionIndex, nNumber));
        }
        ...
        */
        public bool Trigger(ushort nNumber) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_Trigger(handle_, nNumber));
        }
        ...
        */
        public bool TriggerSync(uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo) {
            ...
            return CheckHResult(Mallincam_TriggerSyncV4(handle_, nWaitMS, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool TriggerSync(uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo) {
            ...
            return CheckHResult(Mallincam_TriggerSync(handle_, nWaitMS, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool put_Size(int nWidth, int nHeight) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Size(handle_, nWidth, nHeight));
        }
        ...
        public bool get_Size(out int nWidth, out int nHeight) {
            ...
            return CheckHResult(Mallincam_get_Size(handle_, out nWidth, out nHeight));
        }
        ...
        */
        public bool put_eSize(uint nResolutionIndex) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_eSize(handle_, nResolutionIndex));
        }
        ...
        public bool get_eSize(out uint nResolutionIndex) {
            ...
            return CheckHResult(Mallincam_get_eSize(handle_, out nResolutionIndex));
        }
        ...
        */
        public bool get_FinalSize(out int nWidth, out int nHeight) {
            ...
            return CheckHResult(Mallincam_get_FinalSize(handle_, out nWidth, out nHeight));
        }
        ...
        public bool get_Resolution(uint nResolutionIndex, out int pWidth, out int pHeight) {
            ...
            return CheckHResult(Mallincam_get_Resolution(handle_, nResolutionIndex, out pWidth, out pHeight));
        }
        ...
        */
        public bool get_PixelSize(uint nResolutionIndex, out float x, out float y) {
            ...
            return CheckHResult(Mallincam_get_PixelSize(handle_, nResolutionIndex, out x, out y));
        }
        ...
        */
        public bool get_ResolutionRatio(uint nResolutionIndex, out int pNumerator, out int pDenominator) {
            ...
            return CheckHResult(Mallincam_get_ResolutionRatio(handle_, nResolutionIndex, out pNumerator, out pDenominator));
        }
        ...
        */
        public bool get_RawFormat(out uint nFourCC, out uint bitdepth) {
            ...
            return CheckHResult(Mallincam_get_RawFormat(handle_, out nFourCC, out bitdepth));
        }
        ...
        */
        public bool put_RealTime(int val) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_RealTime(handle_, val));
        }
        ...
        public bool get_RealTime(out int val) {
            ...
            return CheckHResult(Mallincam_get_RealTime(handle_, out val));
        }
        ...
        public bool Flush() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_Flush(handle_));
        }
        ...
        */
        public bool get_AutoExpoEnable(out int bAutoExposure) {
            ...
            return CheckHResult(Mallincam_get_AutoExpoEnable(handle_, out bAutoExposure));
        }

        public bool put_AutoExpoEnable(int bAutoExposure) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AutoExpoEnable(handle_, bAutoExposure));
        }
        ...
        public bool get_AutoExpoEnable(out bool bAutoExposure) {
            ...
            int iEnable = 0;
            if (!CheckHResult(Mallincam_get_AutoExpoEnable(handle_, out iEnable)))
                return false;
        ...
        public bool put_AutoExpoEnable(bool bAutoExposure) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AutoExpoEnable(handle_, bAutoExposure ? 1 : 0));
        }
        ...
        public bool get_AutoExpoTarget(out ushort Target) {
            ...
            return CheckHResult(Mallincam_get_AutoExpoTarget(handle_, out Target));
        }

        public bool put_AutoExpoTarget(ushort Target) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AutoExpoTarget(handle_, Target));
        }
        ...
        public bool put_AutoExpoRange(uint maxTime, uint minTime, ushort maxGain, ushort minGain) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AutoExpoRange(handle_, maxTime, minTime, maxGain, minGain));
        }
        ...
        public bool get_AutoExpoRange(out uint maxTime, out uint minTime, out ushort maxGain, out ushort minGain) {
            ...
            return CheckHResult(Mallincam_get_AutoExpoRange(handle_, out maxTime, out minTime, out maxGain, out minGain));
        }

        public bool put_MaxAutoExpoTimeAGain(uint maxTime, ushort maxGain) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_MaxAutoExpoTimeAGain(handle_, maxTime, maxGain));
        }
        ...
        public bool get_MaxAutoExpoTimeAGain(out uint maxTime, out ushort maxGain) {
            ...
            return CheckHResult(Mallincam_get_MaxAutoExpoTimeAGain(handle_, out maxTime, out maxGain));
        }

        public bool put_MinAutoExpoTimeAGain(uint minTime, ushort minGain) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_MinAutoExpoTimeAGain(handle_, minTime, minGain));
        }
        ...
        public bool get_MinAutoExpoTimeAGain(out uint minTime, out ushort minGain) {
            ...
            return CheckHResult(Mallincam_get_MinAutoExpoTimeAGain(handle_, out minTime, out minGain));
        }
        ...
        public bool get_ExpoTime(out uint Time)/* in microseconds */
        {
            ...
            return CheckHResult(Mallincam_get_ExpoTime(handle_, out Time));
        }
        ...
        public bool get_RealExpoTime(out uint Time)/* actual exposure time */
        {
            ...
            return CheckHResult(Mallincam_get_RealExpoTime(handle_, out Time));
        }
        ...
        public bool put_ExpoTime(uint Time)/* in microseconds */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_ExpoTime(handle_, Time));
        }
        ...
        public bool get_ExpTimeRange(out uint nMin, out uint nMax, out uint nDef) {
            ...
            return CheckHResult(Mallincam_get_ExpTimeRange(handle_, out nMin, out nMax, out nDef));
        }
        ...
        public bool get_ExpoAGain(out ushort Gain)/* percent, such as 300 */
        {
            ...
            return CheckHResult(Mallincam_get_ExpoAGain(handle_, out Gain));
        }
        ...
        public bool put_ExpoAGain(ushort Gain)/* percent */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_ExpoAGain(handle_, Gain));
        }
        ...
        public bool get_ExpoAGainRange(out ushort nMin, out ushort nMax, out ushort nDef) {
            ...
            return CheckHResult(Mallincam_get_ExpoAGainRange(handle_, out nMin, out nMax, out nDef));
        }
        ...
        public bool put_LevelRange(ushort[] aLow, ushort[] aHigh) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_LevelRange(handle_, aLow, aHigh));
        }
        ...
        public bool get_LevelRange(ushort[] aLow, ushort[] aHigh) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_LevelRange(handle_, aLow, aHigh));
        }
        ...
        public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow, ushort[] aHigh) {
            ...
            return CheckHResult(Mallincam_put_LevelRangeV2(handle_, mode, ref rc, aLow, aHigh));
        }
        ...
        public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight, ushort[] aLow, ushort[] aHigh) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            RECT rc = new RECT();
            if (!CheckHResult(Mallincam_get_LevelRangeV2(handle_, out mode, out rc, aLow, aHigh)))
                return false;
            roiX = rc.left;
            roiY = rc.top;
        ...
        public bool put_Hue(int Hue) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Hue(handle_, Hue));
        }
        ...
        public bool get_Hue(out int Hue) {
            ...
            return CheckHResult(Mallincam_get_Hue(handle_, out Hue));
        }

        public bool put_Saturation(int Saturation) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Saturation(handle_, Saturation));
        }
        ...
        public bool get_Saturation(out int Saturation) {
            ...
            return CheckHResult(Mallincam_get_Saturation(handle_, out Saturation));
        }

        public bool put_Brightness(int Brightness) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Brightness(handle_, Brightness));
        }
        ...
        public bool get_Brightness(out int Brightness) {
            ...
            return CheckHResult(Mallincam_get_Brightness(handle_, out Brightness));
        }
        ...
        public bool get_Contrast(out int Contrast) {
            ...
            return CheckHResult(Mallincam_get_Contrast(handle_, out Contrast));
        }

        public bool put_Contrast(int Contrast) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Contrast(handle_, Contrast));
        }
        ...
        public bool get_Gamma(out int Gamma) {
            ...
            return CheckHResult(Mallincam_get_Gamma(handle_, out Gamma));
        }

        public bool put_Gamma(int Gamma) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Gamma(handle_, Gamma));
        }
        ...
        public bool get_Chrome(out bool bChrome)    /* monochromatic mode */
        {
            ...
            int iEnable = 0;
            if (!CheckHResult(Mallincam_get_Chrome(handle_, out iEnable)))
                return false;
        ...
        public bool put_Chrome(bool bChrome) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Chrome(handle_, bChrome ? 1 : 0));
        }
        ...
        public bool get_VFlip(out bool bVFlip) /* vertical flip */
        {
            ...
            int iVFlip = 0;
            if (!CheckHResult(Mallincam_get_VFlip(handle_, out iVFlip)))
                return false;
        ...
        public bool put_VFlip(bool bVFlip) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_VFlip(handle_, bVFlip ? 1 : 0));
        }
        ...
        public bool get_HFlip(out bool bHFlip) {
            ...
            int iHFlip = 0;
            if (!CheckHResult(Mallincam_get_HFlip(handle_, out iHFlip)))
                return false;
        ...
        public bool put_HFlip(bool bHFlip)  /* horizontal flip */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_HFlip(handle_, bHFlip ? 1 : 0));
        }
        ...
        public bool get_Negative(out bool bNegative) {
            ...
            int iNegative = 0;
            if (!CheckHResult(Mallincam_get_Negative(handle_, out iNegative)))
                return false;
        ...
        public bool put_Negative(bool bNegative) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Negative(handle_, bNegative ? 1 : 0));
        }

        public bool put_Speed(ushort nSpeed) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Speed(handle_, nSpeed));
        }
        ...
        public bool get_Speed(out ushort pSpeed) {
            ...
            return CheckHResult(Mallincam_get_Speed(handle_, out pSpeed));
        }
        ...
        */
        public bool put_HZ(int nHZ) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_HZ(handle_, nHZ));
        }
        ...
        public bool get_HZ(out int nHZ) {
            ...
            return CheckHResult(Mallincam_get_HZ(handle_, out nHZ));
        }
        ...
        public bool put_Mode(bool bSkip) /* skip or bin */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Mode(handle_, bSkip ? 1 : 0));
        }
        ...
        public bool get_Mode(out bool bSkip) {
            ...
            int iSkip = 0;
            if (!CheckHResult(Mallincam_get_Mode(handle_, out iSkip)))
                return false;
        ...
        public bool put_TempTint(int nTemp, int nTint) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_TempTint(handle_, nTemp, nTint));
        }
        ...
        public bool get_TempTint(out int nTemp, out int nTint) {
            ...
            return CheckHResult(Mallincam_get_TempTint(handle_, out nTemp, out nTint));
        }
        ...
        public bool put_WhiteBalanceGain(int[] aGain) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_WhiteBalanceGain(handle_, aGain));
        }
        ...
        public bool get_WhiteBalanceGain(int[] aGain) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_WhiteBalanceGain(handle_, aGain));
        }
        ...
        public bool put_AWBAuxRect(int X, int Y, int Width, int Height) {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return CheckHResult(Mallincam_put_AWBAuxRect(handle_, ref rc));
        }
        ...
        public bool get_AWBAuxRect(out int X, out int Y, out int Width, out int Height) {
            ...
            RECT rc = new RECT();
            if (!CheckHResult(Mallincam_get_AWBAuxRect(handle_, out rc)))
                return false;
        ...
        public bool put_AEAuxRect(int X, int Y, int Width, int Height) {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return CheckHResult(Mallincam_put_AEAuxRect(handle_, ref rc));
        }
        ...
        public bool get_AEAuxRect(out int X, out int Y, out int Width, out int Height) {
            ...
            RECT rc = new RECT();
            if (!CheckHResult(Mallincam_get_AEAuxRect(handle_, out rc)))
                return false;
        ...
        public bool put_BlackBalance(ushort[] aSub) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_BlackBalance(handle_, aSub));
        }
        ...
        public bool get_BlackBalance(ushort[] aSub) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_BlackBalance(handle_, aSub));
        }
        ...
        public bool put_ABBAuxRect(int X, int Y, int Width, int Height) {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return CheckHResult(Mallincam_put_ABBAuxRect(handle_, ref rc));
        }
        ...
        public bool get_ABBAuxRect(out int X, out int Y, out int Width, out int Height) {
            ...
            RECT rc = new RECT();
            if (!CheckHResult(Mallincam_get_ABBAuxRect(handle_, out rc)))
                return false;
        ...
        public bool get_StillResolution(uint nResolutionIndex, out int pWidth, out int pHeight) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_StillResolution(handle_, nResolutionIndex, out pWidth, out pHeight));
        }

        public bool put_VignetEnable(bool bEnable) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_VignetEnable(handle_, bEnable ? 1 : 0));
        }
        ...
        public bool get_VignetEnable(out bool bEnable) {
            ...
            int iEanble = 0;
            if (!CheckHResult(Mallincam_get_VignetEnable(handle_, out iEanble)))
                return false;
        ...
        public bool put_VignetAmountInt(int nAmount) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_VignetAmountInt(handle_, nAmount));
        }
        ...
        public bool get_VignetAmountInt(out int nAmount) {
            ...
            return CheckHResult(Mallincam_get_VignetAmountInt(handle_, out nAmount));
        }

        public bool put_VignetMidPointInt(int nMidPoint) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_VignetMidPointInt(handle_, nMidPoint));
        }
        ...
        public bool get_VignetMidPointInt(out int nMidPoint) {
            ...
            return CheckHResult(Mallincam_get_VignetMidPointInt(handle_, out nMidPoint));
        }
        ...
        */
        public bool put_LEDState(ushort iLed, ushort iState, ushort iPeriod) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_LEDState(handle_, iLed, iState, iPeriod));
        }

        public int write_EEPROM(uint addr, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_write_EEPROM(handle_, addr, pBuffer, nBufferLen);
        }

        public int write_EEPROM(uint addr, byte[] pBuffer) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_write_EEPROM(handle_, addr, pBuffer, pBuffer.Length);
        }

        public int read_EEPROM(uint addr, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_read_EEPROM(handle_, addr, pBuffer, nBufferLen);
        }

        public int read_EEPROM(uint addr, byte[] pBuffer) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_read_EEPROM(handle_, addr, pBuffer, pBuffer.Length);
        }
        ...
        */
        public int rwc_Flash(uint action, uint addr, uint len, IntPtr pData) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_rwc_Flash(handle_, action, addr, len, pData);
        }
        ...
        public int write_Pipe(uint pipeId, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_write_Pipe(handle_, pipeId, pBuffer, nBufferLen);
        }

        public int read_Pipe(uint pipeId, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_read_Pipe(handle_, pipeId, pBuffer, nBufferLen);
        }

        public int feed_Pipe(uint pipeId) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_feed_Pipe(handle_, pipeId);
        }

        public int write_UART(IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_write_UART(handle_, pBuffer, nBufferLen);
        }

        public int read_UART(IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Mallincam_read_UART(handle_, pBuffer, nBufferLen);
        }

        public bool put_Option(eOPTION iOption, int iValue) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Option(handle_, iOption, iValue));
        }
        ...
        public bool get_Option(eOPTION iOption, out int iValue) {
            ...
            return CheckHResult(Mallincam_get_Option(handle_, iOption, out iValue));
        }
        ...
        */
        public bool get_PixelFormatSupport(sbyte cmd, out int pixelFormat) {
            ...
            return CheckHResult(Mallincam_get_PixelFormatSupport(handle_, cmd, out pixelFormat));
        }
        ...
        */
        public bool put_Binning(string Value, string Method) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Binning(handle_, Value, Method));
        }
        ...
        public bool get_Binning(out string Value, out string Method) {
            ...
            bool ret = CheckHResult(Mallincam_get_Binning(handle_, out valuePtr, out methodPtr));
            if (ret) {
        ...
        public int get_BinningNumber() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return 0;
            return Mallincam_get_BinningNumber(handle_);
        }
        ...
        public bool get_BinningValue(uint index, out string Value) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            IntPtr valuePtr = new IntPtr(0);
            bool ret = CheckHResult(Mallincam_get_BinningValue(handle_, index, out valuePtr));
            if (ret)
                Value = Marshal.PtrToStringAnsi(valuePtr);
            return ret;
        }
        ...
        public bool get_BinningMethod(uint index, out string Method) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            IntPtr methodPtr = new IntPtr(0);
            bool ret = CheckHResult(Mallincam_get_BinningMethod(handle_, index, out methodPtr));
            if (ret)
                Method = Marshal.PtrToStringAnsi(methodPtr);
            return ret;
        }
        ...
        public bool put_SelfTrigger(ref SelfTrigger pSt) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_SelfTrigger(handle_, ref pSt));
        }

        public bool get_SelfTrigger(ref SelfTrigger pSt) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_SelfTrigger(handle_, ref pSt));
        }

        public bool put_Linear(byte[] v8, ushort[] v16) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Linear(handle_, v8, v16));
        }

        public bool put_Curve(byte[] v8, ushort[] v16) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Curve(handle_, v8, v16));
        }
        ...
        public bool put_ColorMatrix(double[] v) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_ColorMatrix(handle_, v));
        }
        ...
        public bool put_InitWBGain(ushort[] v) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_InitWBGain(handle_, v));
        }
        ...
        public bool get_Temperature(out short pTemperature) {
            ...
            return CheckHResult(Mallincam_get_Temperature(handle_, out pTemperature));
        }
        ...
        */
        public bool put_Temperature(short nTemperature) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Temperature(handle_, nTemperature));
        }
        ...
        public bool put_Roi(uint xOffset, uint yOffset, uint xWidth, uint yHeight) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_Roi(handle_, xOffset, yOffset, xWidth, yHeight));
        }
        ...
        public bool get_Roi(out uint pxOffset, out uint pyOffset, out uint pxWidth, out uint pyHeight) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_Roi(handle_, out pxOffset, out pyOffset, out pxWidth, out pyHeight));
        }
        ...
        public bool put_RoiN(uint[] xOffset, uint[] yOffset, uint[] xWidth, uint[] yHeight) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_RoiN(handle_, xOffset, yOffset, xWidth, yHeight, (uint)(xOffset.Length)));
        }

        public bool put_XY(int x, int y) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_XY(handle_, x, y));
        }
        ...
        */
        public bool get_FrameRate(out uint nFrame, out uint nTime, out uint nTotalFrame) {
            ...
            return CheckHResult(Mallincam_get_FrameRate(handle_, out nFrame, out nTime, out nTotalFrame));
        }

        public bool LevelRangeAuto() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_LevelRangeAuto(handle_));
        }
        ...
        public bool AwbOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_AwbOnce(handle_, IntPtr.Zero, IntPtr.Zero));
        }
        ...
        public bool AwbInit() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_AwbInit(handle_, IntPtr.Zero, IntPtr.Zero));
        }

        public bool AbbOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_AbbOnce(handle_, IntPtr.Zero, IntPtr.Zero));
        }
        ...
        public bool FfcOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_FfcOnce(handle_));
        }
        ...
        public bool DfcOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_DfcOnce(handle_));
        }
        ...
        public bool FpncOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_FpncOnce(handle_));
        }

        public bool FfcExport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_FfcExport(handle_, filePath));
        }

        public bool FfcImport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_FfcImport(handle_, filePath));
        }

        public bool DfcExport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_DfcExport(handle_, filePath));
        }

        public bool DfcImport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_DfcImport(handle_, filePath));
        }

        public bool FpncExport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_FpncExport(handle_, filePath));
        }

        public bool FpncImport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_FpncImport(handle_, filePath));
        }
        ...
        public bool IoControl(uint ioLine, eIoControType eType, int outVal, out int inVal) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_IoControl(handle_, ioLine, eType, outVal, out inVal));
        }
        ...
        public bool AAF(eAAF action, int outVal, out int inVal) {
            ...
            return CheckHResult(Mallincam_AAF(handle_, action, outVal, out inVal));
        }
        ...
        public bool get_LensInfo(ref LensInfo pInfo) {
            ...
            if (!CheckHResult(Mallincam_get_LensInfo(handle_, p))) {
        ...
        public bool get_AFState(ref AFState pState) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_AFState(handle_, ref pState));
        }

        public bool put_AFMode(eAFMode mode) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AFMode(handle_, mode));
        }

        public bool put_AFRoi(uint xOffset, uint yOffset, uint xWidth, uint yHeight) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AFRoi(handle_, xOffset, yOffset, xWidth, yHeight));
        }

        public bool put_AFAperture(int iAperture) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AFAperture(handle_, iAperture));
        }

        public bool put_AFFMPos(int iFMPos) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_put_AFFMPos(handle_, iFMPos));
        }
        ...
        public bool get_FocusMotor(out FocusMotor pFocusMotor) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_FocusMotor(handle_, out pFocusMotor));
        }
        ...
        public bool GetHistogram(DelegateHistogramCallback funHistogram) {
            ...
            return CheckHResult(Mallincam_GetHistogram(handle_, pHistogramV1_, id_));
        }
        ...
        public bool GetHistogramV2(DelegateHistogramCallbackV2 funHistogramV2) {
            ...
            return CheckHResult(Mallincam_GetHistogramV2(handle_, pHistogramV2_, id_));
        }
        ...
        */
        public static void deBayerV2(uint nBayer, int nW, int nH, IntPtr input, IntPtr output, byte nBitDepth, byte nBitCount) {
            Mallincam_deBayerV2(nBayer, nW, nH, input, output, nBitDepth, nBitCount);
        }
        ...
        */
        public static int Update(string camId, string filePath, DelegateProgress funProgress) {
            ...
            int ret = Mallincam_Update(camId, filePath, pProgress, id);
        ...
        public static ModelV2 getModel(ushort idVendor, ushort idProduct) {
            return toModelV2(Mallincam_get_Model(idVendor, idProduct));
        }
        ...
        public static int Gain2TempTint(int[] gain, out int temp, out int tint) {
            ...
            return Mallincam_Gain2TempTint(gain, out temp, out tint);
        }

        public static void TempTint2Gain(int temp, int tint, int[] gain) {
            Mallincam_TempTint2Gain(temp, tint, gain);
        }

        public static ModelV2[] allModel() {
            List<ModelV2> a = new List<ModelV2>();
            IntPtr q, p = Mallincam_all_Model();
            do {
        ...
        public static string PixelFormatName(ePIXELFORMAT pixelFormat) {
            IntPtr ptr = Mallincam_get_PixelFormatName(pixelFormat);
            if (IntPtr.Zero == ptr)
                return null;
        ...
        /*
            the object of Mallincam must be obtained by static mothod Open or OpenByIndex, it cannot be obtained by obj = new Mallincam (The constructor is private on purpose)
        */
        private Mallincam(SafeCamHandle h) {
            handle_ = h;
    ...
    private const UnmanagedType ut = UnmanagedType.LPStr;
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_EnumWithName(IntPtr ptr);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern SafeCamHandle Mallincam_Open([MarshalAs(ut)] string camId);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_PullImageV4(SafeCamHandle h, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_PullImageV4(SafeCamHandle h, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_PullImageV4(SafeCamHandle h, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_WaitImageV4(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_WaitImageV4(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_WaitImageV4(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_PullImageV3(SafeCamHandle h, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageV3(SafeCamHandle h, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageV3(SafeCamHandle h, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_WaitImageV3(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_WaitImageV3(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_WaitImageV3(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImage(SafeCamHandle h, IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImage(SafeCamHandle h, byte[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImage(SafeCamHandle h, ushort[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImage(SafeCamHandle h, IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImage(SafeCamHandle h, byte[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImage(SafeCamHandle h, ushort[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageWithRowPitch(SafeCamHandle h, IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageWithRowPitch(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageWithRowPitch(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageWithRowPitch(SafeCamHandle h, IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageWithRowPitch(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageWithRowPitch(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageV2(SafeCamHandle h, IntPtr pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageV2(SafeCamHandle h, byte[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageV2(SafeCamHandle h, ushort[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageV2(SafeCamHandle h, IntPtr pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageV2(SafeCamHandle h, byte[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageV2(SafeCamHandle h, ushort[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageWithRowPitchV2(SafeCamHandle h, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageWithRowPitchV2(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullImageWithRowPitchV2(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageWithRowPitchV2(SafeCamHandle h, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageWithRowPitchV2(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_PullStillImageWithRowPitchV2(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_StartPushModeV4(SafeCamHandle h, DATA_CALLBACK_V4 funData, IntPtr ctxData, EVENT_CALLBACK funEvent, IntPtr ctxEvent);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_StartPushModeV3(SafeCamHandle h, DATA_CALLBACK_V3 funData, IntPtr ctxData, EVENT_CALLBACK funEvent, IntPtr ctxEvent);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Stop(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Pause(SafeCamHandle h, int bPause);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Snap(SafeCamHandle h, uint nResolutionIndex);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_SnapN(SafeCamHandle h, uint nResolutionIndex, uint nNumber);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_SnapR(SafeCamHandle h, uint nResolutionIndex, uint nNumber);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Trigger(SafeCamHandle h, ushort nNumber);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_TriggerSyncV4(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_TriggerSyncV4(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_TriggerSyncV4(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_TriggerSync(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_TriggerSync(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Mallincam_TriggerSync(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Size(SafeCamHandle h, int nWidth, int nHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Size(SafeCamHandle h, out int nWidth, out int nHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_eSize(SafeCamHandle h, uint nResolutionIndex);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_eSize(SafeCamHandle h, out uint nResolutionIndex);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_FinalSize(SafeCamHandle h, out int nWidth, out int nHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_ResolutionNumber(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Resolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth, out int pHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_ResolutionRatio(SafeCamHandle h, uint nResolutionIndex, out int pNumerator, out int pDenominator);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_Field(SafeCamHandle h);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_RawFormat(SafeCamHandle h, out uint nFourCC, out uint bitdepth);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_RealTime(SafeCamHandle h, int val);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_RealTime(SafeCamHandle h, out int val);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Flush(SafeCamHandle h);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Temperature(SafeCamHandle h, out short pTemperature);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Temperature(SafeCamHandle h, short nTemperature);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Roi(SafeCamHandle h, out uint pxOffset, out uint pyOffset, out uint pxWidth, out uint pyHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Roi(SafeCamHandle h, uint xOffset, uint yOffset, uint xWidth, uint yHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_RoiN(SafeCamHandle h, uint[] xoffset, uint[] yoffset, uint[] xWidth, uint[] yHeight, uint Num);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_XY(SafeCamHandle h, int x, int y);
        ...
        */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AutoExpoEnable(SafeCamHandle h, out int bAutoExposure);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AutoExpoEnable(SafeCamHandle h, int bAutoExposure);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AutoExpoTarget(SafeCamHandle h, out ushort Target);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AutoExpoTarget(SafeCamHandle h, ushort Target);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AutoExpoRange(SafeCamHandle h, uint maxTime, uint minTime, ushort maxGain, ushort minGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AutoExpoRange(SafeCamHandle h, out uint maxTime, out uint minTime, out ushort maxGain, out ushort minGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_MaxAutoExpoTimeAGain(SafeCamHandle h, uint maxTime, ushort maxGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_MaxAutoExpoTimeAGain(SafeCamHandle h, out uint maxTime, out ushort maxGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_MinAutoExpoTimeAGain(SafeCamHandle h, uint minTime, ushort minGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_MinAutoExpoTimeAGain(SafeCamHandle h, out uint minTime, out ushort minGain);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_ExpoTime(SafeCamHandle h, out uint Time)/* in microseconds */;
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_ExpoTime(SafeCamHandle h, uint Time)/* inmicroseconds */;
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_RealExpoTime(SafeCamHandle h, out uint Time)/* actual exposure time */;
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_ExpTimeRange(SafeCamHandle h, out uint nMin, out uint nMax, out uint nDef);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_ExpoAGain(SafeCamHandle h, out ushort Gain);/* percent, such as 300 */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_ExpoAGain(SafeCamHandle h, ushort Gain);/* percent */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_ExpoAGainRange(SafeCamHandle h, out ushort nMin, out ushort nMax, out ushort nDef);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_LevelRange(SafeCamHandle h, [In] ushort[] aLow, [In] ushort[] aHigh);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_LevelRange(SafeCamHandle h, [Out] ushort[] aLow, [Out] ushort[] aHigh);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_LevelRangeV2(SafeCamHandle h, ushort mode, ref RECT roiRect, [In] ushort[] aLow, [In] ushort[] aHigh);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_LevelRangeV2(SafeCamHandle h, out ushort mode, out RECT pRoiRect, [Out] ushort[] aLow, [Out] ushort[] aHigh);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Hue(SafeCamHandle h, int Hue);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Hue(SafeCamHandle h, out int Hue);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Saturation(SafeCamHandle h, int Saturation);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Saturation(SafeCamHandle h, out int Saturation);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Brightness(SafeCamHandle h, int Brightness);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Brightness(SafeCamHandle h, out int Brightness);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Contrast(SafeCamHandle h, out int Contrast);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Contrast(SafeCamHandle h, int Contrast);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Gamma(SafeCamHandle h, out int Gamma);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Gamma(SafeCamHandle h, int Gamma);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Chrome(SafeCamHandle h, out int bChrome);    /* monochromatic mode */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Chrome(SafeCamHandle h, int bChrome);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_VFlip(SafeCamHandle h, out int bVFlip);  /* vertical flip */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_VFlip(SafeCamHandle h, int bVFlip);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_HFlip(SafeCamHandle h, out int bHFlip);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_HFlip(SafeCamHandle h, int bHFlip);  /* horizontal flip */

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Negative(SafeCamHandle h, out int bNegative);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Negative(SafeCamHandle h, int bNegative);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Speed(SafeCamHandle h, ushort nSpeed);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Speed(SafeCamHandle h, out ushort pSpeed);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_MaxSpeed(SafeCamHandle h);/* get the maximum speed, "Frame Speed Level", speed range = [0, max] */

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_MaxBitDepth(SafeCamHandle h);/* get the max bitdepth of this camera, such as 8, 10, 12, 14, 16 */

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_FanMaxSpeed(SafeCamHandle h);/* get the maximum fan speed, the fan speed range = [0, max], closed interval */

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_HZ(SafeCamHandle h, int nHZ);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_HZ(SafeCamHandle h, out int nHZ);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Mode(SafeCamHandle h, int bSkip); /* skip or bin */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Mode(SafeCamHandle h, out int bSkip);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_TempTint(SafeCamHandle h, int nTemp, int nTint);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_TempTint(SafeCamHandle h, out int nTemp, out int nTint);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_WhiteBalanceGain(SafeCamHandle h, [In] int[] aGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_WhiteBalanceGain(SafeCamHandle h, [Out] int[] aGain);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_BlackBalance(SafeCamHandle h, [In] ushort[] aSub);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_BlackBalance(SafeCamHandle h, [Out] ushort[] aSub);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AWBAuxRect(SafeCamHandle h, ref RECT pAuxRect);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AWBAuxRect(SafeCamHandle h, out RECT pAuxRect);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AEAuxRect(SafeCamHandle h, ref RECT pAuxRect);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AEAuxRect(SafeCamHandle h, out RECT pAuxRect);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_ABBAuxRect(SafeCamHandle h, ref RECT pAuxRect);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_ABBAuxRect(SafeCamHandle h, out RECT pAuxRect);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_MonoMode(SafeCamHandle h);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_StillResolutionNumber(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_StillResolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth, out int pHeight);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Revision(SafeCamHandle h, out ushort pRevision);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_SerialNumber(SafeCamHandle h, IntPtr sn);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_FwVersion(SafeCamHandle h, IntPtr fwver);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_HwVersion(SafeCamHandle h, IntPtr hwver);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_FpgaVersion(SafeCamHandle h, IntPtr fpgaver);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        ...
        */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_VignetEnable(SafeCamHandle h, int bEnable);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_VignetEnable(SafeCamHandle h, out int bEnable);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_VignetAmountInt(SafeCamHandle h, int nAmount);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_VignetAmountInt(SafeCamHandle h, out int nAmount);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_VignetMidPointInt(SafeCamHandle h, int nMidPoint);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_VignetMidPointInt(SafeCamHandle h, out int nMidPoint);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_AwbOnce(SafeCamHandle h, IntPtr funTT, IntPtr ctxTT);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_AwbInit(SafeCamHandle h, IntPtr funWB, IntPtr ctxWB);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_LevelRangeAuto(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACKV1 funHistogramV1, IntPtr ctxHistogramV1);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_GetHistogramV2(SafeCamHandle h, HISTOGRAM_CALLBACKV2 funHistogramV2, IntPtr ctxHistogramV2);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_AbbOnce(SafeCamHandle h, IntPtr funBB, IntPtr ctxBB);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_LEDState(SafeCamHandle h, ushort iLed, ushort iState, ushort iPeriod);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_write_EEPROM(SafeCamHandle h, uint addr, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_write_EEPROM(SafeCamHandle h, uint addr, byte[] pBuffer, int nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_read_EEPROM(SafeCamHandle h, uint addr, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_read_EEPROM(SafeCamHandle h, uint addr, byte[] pBuffer, int nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_rwc_Flash(SafeCamHandle h, uint action, uint addr, uint len, IntPtr pData);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_rwc_Flash(SafeCamHandle h, uint action, uint addr, uint len, byte[] pData);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_write_Pipe(SafeCamHandle h, uint pipeId, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_read_Pipe(SafeCamHandle h, uint pipeId, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_feed_Pipe(SafeCamHandle h, uint pipeId);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_write_UART(SafeCamHandle h, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_read_UART(SafeCamHandle h, IntPtr pBuffer, uint nBufferLen);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Option(SafeCamHandle h, eOPTION iOption, int iValue);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Option(SafeCamHandle h, eOPTION iOption, out int iValue);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_PixelFormatSupport(SafeCamHandle h, sbyte cmd, out int iValue);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern IntPtr Mallincam_get_PixelFormatName(ePIXELFORMAT val);
        ...
        */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Binning(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string Value, [MarshalAs(UnmanagedType.LPStr)] string Method);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_Binning(SafeCamHandle h, out IntPtr Value, out IntPtr Method);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_BinningNumber(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_BinningValue(SafeCamHandle h, uint index, out IntPtr Value);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_BinningMethod(SafeCamHandle h, uint index, out IntPtr Value);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_SelfTrigger(SafeCamHandle h, ref SelfTrigger pSt);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_SelfTrigger(SafeCamHandle h, ref SelfTrigger pSt);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Linear(SafeCamHandle h, byte[] v8, ushort[] v16);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_Curve(SafeCamHandle h, byte[] v8, ushort[] v16);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_ColorMatrix(SafeCamHandle h, double[] v);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_InitWBGain(SafeCamHandle h, ushort[] v);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_FrameRate(SafeCamHandle h, out uint nFrame, out uint nTime, out uint nTotalFrame);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_FfcOnce(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_DfcOnce(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_FpncOnce(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_FfcExport(SafeCamHandle h, [MarshalAs(ut)] string filePath);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_FfcImport(SafeCamHandle h, [MarshalAs(ut)] string filePath);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_DfcExport(SafeCamHandle h, [MarshalAs(ut)] string filePath);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_DfcImport(SafeCamHandle h, [MarshalAs(ut)] string filePath);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_FpncExport(SafeCamHandle h, [MarshalAs(ut)] string filePath);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_FpncImport(SafeCamHandle h, [MarshalAs(ut)] string filePath);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_IoControl(SafeCamHandle h, uint ioLine, eIoControType eType, int outVal, out int inVal);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_AAF(SafeCamHandle h, eAAF action, int outVal, out int inVal);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_LensInfo(SafeCamHandle h, IntPtr pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AFState(SafeCamHandle h, ref AFState pState);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AFMode(SafeCamHandle h, eAFMode mode);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AFRoi(SafeCamHandle h, uint xOffset, uint yOffset, uint xWidth, uint yHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AFAperture(SafeCamHandle h, int iAperture);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_put_AFFMPos(SafeCamHandle h, int iFMPos);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_FocusMotor(SafeCamHandle h, out FocusMotor pFocusMotor);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Replug([MarshalAs(ut)] string camId);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Update([MarshalAs(ut)] string camId, [MarshalAs(ut)] string filePath, PROGRESS_CALLBACK funProgress, IntPtr ctxProgress);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_GigeEnable(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern IntPtr Mallincam_get_Model(ushort idVendor, ushort idProduct);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern IntPtr Mallincam_all_Model();

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Gain2TempTint(int[] gain, out int temp, out int tint);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern void Mallincam_TempTint2Gain(int temp, int tint, [Out] int[] gain);
    }
}