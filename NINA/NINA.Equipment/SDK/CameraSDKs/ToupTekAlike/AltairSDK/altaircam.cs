...
namespace Altair {
    ...
    public class Altaircam : IDisposable {
        ...
        public enum eFLAG : ulong {
            ...
            /* pixel format, RAW 10bits packed */
            FLAG_RAW10PACK = 0x0200000000000000,
            /* usb3.2 */
            FLAG_USB32 = 0x0400000000000000,
            /* usb3.2 camera connected to usb3.0 port */
            FLAG_USB32_OVER_USB30 = 0x0800000000000000
        };
        ...
        public enum eOPTION : uint {
            ...
            */
            ...
            /* Mode of seq & timestamp: 0 => reset to 0 automatically; 1 => never reset automatically; default: 0 */
            OPTION_MODE_SEQ_TIMESTAMP = 0x7b,
            /* Timed trigger number */
            OPTION_TIMED_TRIGGER_NUM = 0x7c,
            /* Timed trigger: lower 32 bits of  64-bit integer, nanosecond since epoch (00:00:00 UTC on Thursday, 1 January 1970, see https://en.wikipedia.org/wiki/Unix_time) */
            OPTION_TIMED_TRIGGER_LOW = 0x20000000,
            /* Timed trigger: high 32 bits. The lower 32 bits must be set first, followed by the higher 32 bits */
            OPTION_TIMED_TRIGGER_HIGH = 0x40000000,
            /* trigger threshold of auto exposure */
            OPTION_AUTOEXP_THLD_TRIGGER = 0x7d,
            OPTION_LANE = 0x7e,
            /* Voltage bias */
            OPTION_VOLTAGEBIAS = 0x7f,
            /* Voltage bias range: min (low 16bits), max (high 16bits) */
            OPTION_VOLTAGEBIAS_RANGE = 0x80,
            OPTION_READ_TIME = 0x81,
            OPTION_ALL_EXPO_TIME = 0x82,
            OPTION_CAMERA_PERIOD = 0x83
        };
        ...
        public const int E_UNREACH = unchecked((int)0x80072743);
        ...
        public const int AUTOEXPO_THLD_TRIGGER_DEF = 5;     /* auto exposure trigger threshold */
        public const int AUTOEXPO_THLD_TRIGGER_MIN = 2;     /* auto exposure trigger threshold */
        public const int AUTOEXPO_THLD_TRIGGER_MAX = 64;    /* auto exposure trigger threshold */
    ...
    public static extern void memcpy(IntPtr dest, IntPtr src, IntPtr count);
        ...
        /* get the version of this dll/so, which is: 58.28430.20250506 */
        ...
        public static DeviceV2[] EnumV2() {
            ...
            return Ptr2Device(p, Altaircam_EnumV2(p));
        }

        public static DeviceV2[] EnumWithName() {
            IntPtr p = Marshal.AllocHGlobal(512 * 128);
            return Ptr2Device(p, Altaircam_EnumWithName(p));
        }
        ...
        public static int GigeEnable(DelegateHotplug funHotplug) {
            ...
            return Altaircam_GigeEnable(pHotplug, id);
        }
        ...
        */
        ...
        public static Altaircam Open(string camId) {
            SafeCamHandle tmphandle = Altaircam_Open(camId);
        ...
        */
        ...
        public uint ResolutionNumber {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Altaircam_get_ResolutionNumber(handle_);
            }
        }
        ...
        public uint StillResolutionNumber {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Altaircam_get_StillResolutionNumber(handle_);
            }
        }
        ...
        public bool MonoMode {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return false;
                return (0 == Altaircam_get_MonoMode(handle_));
            }
        }
        ...
        public uint MaxSpeed {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Altaircam_get_MaxSpeed(handle_);
            }
        }
        ...
        public uint MaxBitDepth {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Altaircam_get_MaxBitDepth(handle_);
            }
        }
        ...
        public uint FanMaxSpeed {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return Altaircam_get_FanMaxSpeed(handle_);
            }
        }
        ...
        public short TecTargetMax {
            get {
                if (handle_ != null && !handle_.IsInvalid && !handle_.IsClosed) {
                    int range = 0;
                    if (CheckHResult(Altaircam_get_Option(handle_, eOPTION.OPTION_TECTARGET_RANGE, out range)))
        ...
        public ushort Revision {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return rev;
                Altaircam_get_Revision(handle_, out rev);
                return rev;
            }
        }
        ...
        public string SerialNumber {
            get {
                ...
                if (Altaircam_get_SerialNumber(handle_, ptr) >= 0)
        ...
        public string FwVersion {
            get {
                ...
                if (Altaircam_get_FwVersion(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public string HwVersion {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return str;
                IntPtr ptr = Marshal.AllocHGlobal(32);
                if (Altaircam_get_HwVersion(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public string ProductionDate {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return str;
                IntPtr ptr = Marshal.AllocHGlobal(32);
                if (Altaircam_get_ProductionDate(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public string FpgaVersion {
            get {
                ...
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return str;
                IntPtr ptr = Marshal.AllocHGlobal(32);
                if (Altaircam_get_FpgaVersion(handle_, ptr) >= 0)
                    str = Marshal.PtrToStringAnsi(ptr);
                Marshal.FreeHGlobal(ptr);
                return str;
            }
        ...
        public uint Field {
            get {
                if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                    return 0;
                return (uint)Altaircam_get_Field(handle_);
            }
        }
        ...
        public bool StartPullModeWithWndMsg(IntPtr hWnd, uint nMsg) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_StartPullModeWithWndMsg(handle_, hWnd, nMsg));
        }
#endif
        ...
        public bool StartPullModeWithCallback(DelegateEventCallback funEvent) {
            ...
            if (funEvent != null) {
                ...
                return CheckHResult(Altaircam_StartPullModeWithCallback(handle_, pEvent_, id_));
            } else {
                return CheckHResult(Altaircam_StartPullModeWithCallback(handle_, null, IntPtr.Zero));
            }
        }
        ...
        public bool PullImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Altaircam_PullImage(handle_, pImageData, bits, out pnWidth, out pnHeight));
        }
        ...
        public bool PullImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Altaircam_PullImageV2(handle_, pImageData, bits, out pInfo));
        }
        ...
        public bool PullStillImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Altaircam_PullStillImage(handle_, pImageData, bits, out pnWidth, out pnHeight));
        }
        ...
        public bool PullStillImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Altaircam_PullStillImageV2(handle_, pImageData, bits, out pInfo));
        }
        ...
        */
        public bool PullImage(IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo) {
            ...
            return CheckHResult(Altaircam_PullImageV4(handle_, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool PullImageV3(IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo) {
            ...
            return CheckHResult(Altaircam_PullImageV3(handle_, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool WaitImage(uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo) {
            ...
            return CheckHResult(Altaircam_WaitImageV4(handle_, nWaitMS, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool WaitImageV3(uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo) {
            ...
            return CheckHResult(Altaircam_WaitImageV3(handle_, nWaitMS, pImageData, bStill, bits, rowPitch, out pInfo));
        }
        ...
        public bool PullImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Altaircam_PullImageWithRowPitch(handle_, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
        }
        ...
        public bool PullImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Altaircam_PullImageWithRowPitchV2(handle_, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool PullStillImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight) {
            ...
            return CheckHResult(Altaircam_PullStillImageWithRowPitch(handle_, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
        }
        ...
        public bool PullStillImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo) {
            ...
            return CheckHResult(Altaircam_PullStillImageWithRowPitchV2(handle_, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool StartPushModeV4(DelegateDataCallbackV4 funData, DelegateEventCallback funEvent) {
            ...
            pDataV4_ = delegate (IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr ctxData)
            {
                ...
                if (map_.TryGetValue(ctxData.ToInt32(), out obj) && (obj != null)) {
                    Altaircam pthis = obj as Altaircam;
                    if (pthis != null)
                        pthis.DataCallbackV4(pData, pInfo, bSnap);
                }
            };
            pEvent_ = new EVENT_CALLBACK(EventCallback);
            return CheckHResult(Altaircam_StartPushModeV4(handle_, pDataV4_, id_, pEvent_, id_));
        }
        ...
        public bool StartPushModeV3(DelegateDataCallbackV3 funData, DelegateEventCallback funEvent) {
            ...
            pEvent_ = new EVENT_CALLBACK(EventCallback);
            return CheckHResult(Altaircam_StartPushModeV3(handle_, pDataV3_, id_, pEvent_, id_));
        }

        public bool Stop() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_Stop(handle_));
        }
        ...
        public bool Pause(bool bPause) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_Pause(handle_, bPause ? 1 : 0));
        }
        ...
        public bool Snap(uint nResolutionIndex) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_Snap(handle_, nResolutionIndex));
        }
        ...
        public bool SnapN(uint nResolutionIndex, uint nNumber) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_SnapN(handle_, nResolutionIndex, nNumber));
        }
        ...
        public bool SnapR(uint nResolutionIndex, uint nNumber) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_SnapR(handle_, nResolutionIndex, nNumber));
        }
        ...
        */
        public bool Trigger(ushort nNumber) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_Trigger(handle_, nNumber));
        }
        ...
        */
        public bool TriggerSync(uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo) {
            ...
            return CheckHResult(Altaircam_TriggerSyncV4(handle_, nWaitMS, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool TriggerSync(uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo) {
            ...
            return CheckHResult(Altaircam_TriggerSync(handle_, nWaitMS, pImageData, bits, rowPitch, out pInfo));
        }
        ...
        public bool put_Size(int nWidth, int nHeight) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Size(handle_, nWidth, nHeight));
        }
        ...
        public bool get_Size(out int nWidth, out int nHeight) {
            ...
            return CheckHResult(Altaircam_get_Size(handle_, out nWidth, out nHeight));
        }
        ...
        */
        public bool put_eSize(uint nResolutionIndex) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_eSize(handle_, nResolutionIndex));
        }
        ...
        public bool get_eSize(out uint nResolutionIndex) {
            ...
            return CheckHResult(Altaircam_get_eSize(handle_, out nResolutionIndex));
        }
        ...
        */
        public bool get_FinalSize(out int nWidth, out int nHeight) {
            ...
            return CheckHResult(Altaircam_get_FinalSize(handle_, out nWidth, out nHeight));
        }
        ...
        public bool get_Resolution(uint nResolutionIndex, out int pWidth, out int pHeight) {
            ...
            return CheckHResult(Altaircam_get_Resolution(handle_, nResolutionIndex, out pWidth, out pHeight));
        }
        ...
        */
        public bool get_PixelSize(uint nResolutionIndex, out float x, out float y) {
            ...
            return CheckHResult(Altaircam_get_PixelSize(handle_, nResolutionIndex, out x, out y));
        }
        ...
        */
        public bool get_ResolutionRatio(uint nResolutionIndex, out int pNumerator, out int pDenominator) {
            ...
            return CheckHResult(Altaircam_get_ResolutionRatio(handle_, nResolutionIndex, out pNumerator, out pDenominator));
        }
        ...
        */
        public bool get_RawFormat(out uint nFourCC, out uint bitdepth) {
            ...
            return CheckHResult(Altaircam_get_RawFormat(handle_, out nFourCC, out bitdepth));
        }
        ...
        */
        public bool put_RealTime(int val) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_RealTime(handle_, val));
        }
        ...
        public bool get_RealTime(out int val) {
            ...
            return CheckHResult(Altaircam_get_RealTime(handle_, out val));
        }
        ...
        public bool Flush() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_Flush(handle_));
        }
        ...
        */
        public bool get_AutoExpoEnable(out int bAutoExposure) {
            ...
            return CheckHResult(Altaircam_get_AutoExpoEnable(handle_, out bAutoExposure));
        }

        public bool put_AutoExpoEnable(int bAutoExposure) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AutoExpoEnable(handle_, bAutoExposure));
        }
        ...
        public bool get_AutoExpoEnable(out bool bAutoExposure) {
            ...
            int iEnable = 0;
            if (!CheckHResult(Altaircam_get_AutoExpoEnable(handle_, out iEnable)))
                return false;
        ...
        public bool put_AutoExpoEnable(bool bAutoExposure) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AutoExpoEnable(handle_, bAutoExposure ? 1 : 0));
        }
        ...
        public bool get_AutoExpoTarget(out ushort Target) {
            ...
            return CheckHResult(Altaircam_get_AutoExpoTarget(handle_, out Target));
        }

        public bool put_AutoExpoTarget(ushort Target) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AutoExpoTarget(handle_, Target));
        }
        ...
        public bool put_AutoExpoRange(uint maxTime, uint minTime, ushort maxGain, ushort minGain) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AutoExpoRange(handle_, maxTime, minTime, maxGain, minGain));
        }
        ...
        public bool get_AutoExpoRange(out uint maxTime, out uint minTime, out ushort maxGain, out ushort minGain) {
            ...
            return CheckHResult(Altaircam_get_AutoExpoRange(handle_, out maxTime, out minTime, out maxGain, out minGain));
        }

        public bool put_MaxAutoExpoTimeAGain(uint maxTime, ushort maxGain) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_MaxAutoExpoTimeAGain(handle_, maxTime, maxGain));
        }
        ...
        public bool get_MaxAutoExpoTimeAGain(out uint maxTime, out ushort maxGain) {
            ...
            return CheckHResult(Altaircam_get_MaxAutoExpoTimeAGain(handle_, out maxTime, out maxGain));
        }

        public bool put_MinAutoExpoTimeAGain(uint minTime, ushort minGain) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_MinAutoExpoTimeAGain(handle_, minTime, minGain));
        }
        ...
        public bool get_MinAutoExpoTimeAGain(out uint minTime, out ushort minGain) {
            ...
            return CheckHResult(Altaircam_get_MinAutoExpoTimeAGain(handle_, out minTime, out minGain));
        }
        ...
        public bool get_ExpoTime(out uint Time)/* in microseconds */
        {
            ...
            return CheckHResult(Altaircam_get_ExpoTime(handle_, out Time));
        }
        ...
        public bool get_RealExpoTime(out uint Time)/* actual exposure time */
        {
            ...
            return CheckHResult(Altaircam_get_RealExpoTime(handle_, out Time));
        }
        ...
        public bool put_ExpoTime(uint Time)/* in microseconds */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_ExpoTime(handle_, Time));
        }
        ...
        public bool get_ExpTimeRange(out uint nMin, out uint nMax, out uint nDef) {
            ...
            return CheckHResult(Altaircam_get_ExpTimeRange(handle_, out nMin, out nMax, out nDef));
        }
        ...
        public bool get_ExpoAGain(out ushort Gain)/* percent, such as 300 */
        {
            ...
            return CheckHResult(Altaircam_get_ExpoAGain(handle_, out Gain));
        }
        ...
        public bool put_ExpoAGain(ushort Gain)/* percent */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_ExpoAGain(handle_, Gain));
        }
        ...
        public bool get_ExpoAGainRange(out ushort nMin, out ushort nMax, out ushort nDef) {
            ...
            return CheckHResult(Altaircam_get_ExpoAGainRange(handle_, out nMin, out nMax, out nDef));
        }
        ...
        public bool put_LevelRange(ushort[] aLow, ushort[] aHigh) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_LevelRange(handle_, aLow, aHigh));
        }
        ...
        public bool get_LevelRange(ushort[] aLow, ushort[] aHigh) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_LevelRange(handle_, aLow, aHigh));
        }
        ...
        public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow, ushort[] aHigh) {
            ...
            return CheckHResult(Altaircam_put_LevelRangeV2(handle_, mode, ref rc, aLow, aHigh));
        }
        ...
        public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight, ushort[] aLow, ushort[] aHigh) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            RECT rc = new RECT();
            if (!CheckHResult(Altaircam_get_LevelRangeV2(handle_, out mode, out rc, aLow, aHigh)))
                return false;
            roiX = rc.left;
            roiY = rc.top;
        ...
        public bool put_Hue(int Hue) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Hue(handle_, Hue));
        }
        ...
        public bool get_Hue(out int Hue) {
            ...
            return CheckHResult(Altaircam_get_Hue(handle_, out Hue));
        }

        public bool put_Saturation(int Saturation) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Saturation(handle_, Saturation));
        }
        ...
        public bool get_Saturation(out int Saturation) {
            ...
            return CheckHResult(Altaircam_get_Saturation(handle_, out Saturation));
        }

        public bool put_Brightness(int Brightness) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Brightness(handle_, Brightness));
        }
        ...
        public bool get_Brightness(out int Brightness) {
            ...
            return CheckHResult(Altaircam_get_Brightness(handle_, out Brightness));
        }
        ...
        public bool get_Contrast(out int Contrast) {
            ...
            return CheckHResult(Altaircam_get_Contrast(handle_, out Contrast));
        }

        public bool put_Contrast(int Contrast) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Contrast(handle_, Contrast));
        }
        ...
        public bool get_Gamma(out int Gamma) {
            ...
            return CheckHResult(Altaircam_get_Gamma(handle_, out Gamma));
        }

        public bool put_Gamma(int Gamma) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Gamma(handle_, Gamma));
        }
        ...
        public bool get_Chrome(out bool bChrome)    /* monochromatic mode */
        {
            ...
            int iEnable = 0;
            if (!CheckHResult(Altaircam_get_Chrome(handle_, out iEnable)))
                return false;
        ...
        public bool put_Chrome(bool bChrome) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Chrome(handle_, bChrome ? 1 : 0));
        }
        ...
        public bool get_VFlip(out bool bVFlip) /* vertical flip */
        {
            ...
            int iVFlip = 0;
            if (!CheckHResult(Altaircam_get_VFlip(handle_, out iVFlip)))
                return false;
        ...
        public bool put_VFlip(bool bVFlip) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_VFlip(handle_, bVFlip ? 1 : 0));
        }
        ...
        public bool get_HFlip(out bool bHFlip) {
            ...
            int iHFlip = 0;
            if (!CheckHResult(Altaircam_get_HFlip(handle_, out iHFlip)))
                return false;
        ...
        public bool put_HFlip(bool bHFlip)  /* horizontal flip */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_HFlip(handle_, bHFlip ? 1 : 0));
        }
        ...
        public bool get_Negative(out bool bNegative) {
            ...
            int iNegative = 0;
            if (!CheckHResult(Altaircam_get_Negative(handle_, out iNegative)))
                return false;
        ...
        public bool put_Negative(bool bNegative) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Negative(handle_, bNegative ? 1 : 0));
        }

        public bool put_Speed(ushort nSpeed) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Speed(handle_, nSpeed));
        }
        ...
        public bool get_Speed(out ushort pSpeed) {
            ...
            return CheckHResult(Altaircam_get_Speed(handle_, out pSpeed));
        }
        ...
        */
        public bool put_HZ(int nHZ) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_HZ(handle_, nHZ));
        }
        ...
        public bool get_HZ(out int nHZ) {
            ...
            return CheckHResult(Altaircam_get_HZ(handle_, out nHZ));
        }
        ...
        public bool put_Mode(bool bSkip) /* skip or bin */
        {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Mode(handle_, bSkip ? 1 : 0));
        }
        ...
        public bool get_Mode(out bool bSkip) {
            ...
            int iSkip = 0;
            if (!CheckHResult(Altaircam_get_Mode(handle_, out iSkip)))
                return false;
        ...
        public bool put_TempTint(int nTemp, int nTint) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_TempTint(handle_, nTemp, nTint));
        }
        ...
        public bool get_TempTint(out int nTemp, out int nTint) {
            ...
            return CheckHResult(Altaircam_get_TempTint(handle_, out nTemp, out nTint));
        }
        ...
        public bool put_WhiteBalanceGain(int[] aGain) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_WhiteBalanceGain(handle_, aGain));
        }
        ...
        public bool get_WhiteBalanceGain(int[] aGain) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_WhiteBalanceGain(handle_, aGain));
        }
        ...
        public bool put_AWBAuxRect(int X, int Y, int Width, int Height) {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return CheckHResult(Altaircam_put_AWBAuxRect(handle_, ref rc));
        }
        ...
        public bool get_AWBAuxRect(out int X, out int Y, out int Width, out int Height) {
            ...
            RECT rc = new RECT();
            if (!CheckHResult(Altaircam_get_AWBAuxRect(handle_, out rc)))
                return false;
        ...
        public bool put_AEAuxRect(int X, int Y, int Width, int Height) {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return CheckHResult(Altaircam_put_AEAuxRect(handle_, ref rc));
        }
        ...
        public bool get_AEAuxRect(out int X, out int Y, out int Width, out int Height) {
            ...
            RECT rc = new RECT();
            if (!CheckHResult(Altaircam_get_AEAuxRect(handle_, out rc)))
                return false;
        ...
        public bool put_BlackBalance(ushort[] aSub) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_BlackBalance(handle_, aSub));
        }
        ...
        public bool get_BlackBalance(ushort[] aSub) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_BlackBalance(handle_, aSub));
        }
        ...
        public bool put_ABBAuxRect(int X, int Y, int Width, int Height) {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return CheckHResult(Altaircam_put_ABBAuxRect(handle_, ref rc));
        }
        ...
        public bool get_ABBAuxRect(out int X, out int Y, out int Width, out int Height) {
            ...
            RECT rc = new RECT();
            if (!CheckHResult(Altaircam_get_ABBAuxRect(handle_, out rc)))
                return false;
        ...
        public bool get_StillResolution(uint nResolutionIndex, out int pWidth, out int pHeight) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_StillResolution(handle_, nResolutionIndex, out pWidth, out pHeight));
        }

        public bool put_VignetEnable(bool bEnable) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_VignetEnable(handle_, bEnable ? 1 : 0));
        }
        ...
        public bool get_VignetEnable(out bool bEnable) {
            ...
            int iEanble = 0;
            if (!CheckHResult(Altaircam_get_VignetEnable(handle_, out iEanble)))
                return false;
        ...
        public bool put_VignetAmountInt(int nAmount) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_VignetAmountInt(handle_, nAmount));
        }
        ...
        public bool get_VignetAmountInt(out int nAmount) {
            ...
            return CheckHResult(Altaircam_get_VignetAmountInt(handle_, out nAmount));
        }

        public bool put_VignetMidPointInt(int nMidPoint) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_VignetMidPointInt(handle_, nMidPoint));
        }
        ...
        public bool get_VignetMidPointInt(out int nMidPoint) {
            ...
            return CheckHResult(Altaircam_get_VignetMidPointInt(handle_, out nMidPoint));
        }
        ...
        */
        public bool put_LEDState(ushort iLed, ushort iState, ushort iPeriod) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_LEDState(handle_, iLed, iState, iPeriod));
        }

        public int write_EEPROM(uint addr, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_write_EEPROM(handle_, addr, pBuffer, nBufferLen);
        }

        public int write_EEPROM(uint addr, byte[] pBuffer) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_write_EEPROM(handle_, addr, pBuffer, pBuffer.Length);
        }

        public int read_EEPROM(uint addr, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_read_EEPROM(handle_, addr, pBuffer, nBufferLen);
        }

        public int read_EEPROM(uint addr, byte[] pBuffer) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_read_EEPROM(handle_, addr, pBuffer, pBuffer.Length);
        }
        ...
        */
        public int rwc_Flash(uint action, uint addr, uint len, IntPtr pData) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_rwc_Flash(handle_, action, addr, len, pData);
        }
        ...
        public int write_Pipe(uint pipeId, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_write_Pipe(handle_, pipeId, pBuffer, nBufferLen);
        }

        public int read_Pipe(uint pipeId, IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_read_Pipe(handle_, pipeId, pBuffer, nBufferLen);
        }

        public int feed_Pipe(uint pipeId) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_feed_Pipe(handle_, pipeId);
        }

        public int write_UART(IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_write_UART(handle_, pBuffer, nBufferLen);
        }

        public int read_UART(IntPtr pBuffer, uint nBufferLen) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return E_UNEXPECTED;
            return Altaircam_read_UART(handle_, pBuffer, nBufferLen);
        }

        public bool put_Option(eOPTION iOption, int iValue) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Option(handle_, iOption, iValue));
        }
        ...
        public bool get_Option(eOPTION iOption, out int iValue) {
            ...
            return CheckHResult(Altaircam_get_Option(handle_, iOption, out iValue));
        }
        ...
        */
        public bool get_PixelFormatSupport(sbyte cmd, out int pixelFormat) {
            ...
            return CheckHResult(Altaircam_get_PixelFormatSupport(handle_, cmd, out pixelFormat));
        }
        ...
        */
        public bool put_Binning(string Value, string Method) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Binning(handle_, Value, Method));
        }
        ...
        public bool get_Binning(out string Value, out string Method) {
            ...
            bool ret = CheckHResult(Altaircam_get_Binning(handle_, out valuePtr, out methodPtr));
            if (ret) {
        ...
        public int get_BinningNumber() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return 0;
            return Altaircam_get_BinningNumber(handle_);
        }
        ...
        public bool get_BinningValue(uint index, out string Value) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            IntPtr valuePtr = new IntPtr(0);
            bool ret = CheckHResult(Altaircam_get_BinningValue(handle_, index, out valuePtr));
            if (ret)
                Value = Marshal.PtrToStringAnsi(valuePtr);
            return ret;
        }
        ...
        public bool get_BinningMethod(uint index, out string Method) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            IntPtr methodPtr = new IntPtr(0);
            bool ret = CheckHResult(Altaircam_get_BinningMethod(handle_, index, out methodPtr));
            if (ret)
                Method = Marshal.PtrToStringAnsi(methodPtr);
            return ret;
        }
        ...
        public bool put_SelfTrigger(ref SelfTrigger pSt) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_SelfTrigger(handle_, ref pSt));
        }

        public bool get_SelfTrigger(ref SelfTrigger pSt) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_SelfTrigger(handle_, ref pSt));
        }

        public bool put_Linear(byte[] v8, ushort[] v16) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Linear(handle_, v8, v16));
        }

        public bool put_Curve(byte[] v8, ushort[] v16) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Curve(handle_, v8, v16));
        }
        ...
        public bool put_ColorMatrix(double[] v) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_ColorMatrix(handle_, v));
        }
        ...
        public bool put_InitWBGain(ushort[] v) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_InitWBGain(handle_, v));
        }
        ...
        public bool get_Temperature(out short pTemperature) {
            ...
            return CheckHResult(Altaircam_get_Temperature(handle_, out pTemperature));
        }
        ...
        */
        public bool put_Temperature(short nTemperature) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Temperature(handle_, nTemperature));
        }
        ...
        public bool put_Roi(uint xOffset, uint yOffset, uint xWidth, uint yHeight) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_Roi(handle_, xOffset, yOffset, xWidth, yHeight));
        }
        ...
        public bool get_Roi(out uint pxOffset, out uint pyOffset, out uint pxWidth, out uint pyHeight) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_Roi(handle_, out pxOffset, out pyOffset, out pxWidth, out pyHeight));
        }
        ...
        public bool put_RoiN(uint[] xOffset, uint[] yOffset, uint[] xWidth, uint[] yHeight) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_RoiN(handle_, xOffset, yOffset, xWidth, yHeight, (uint)(xOffset.Length)));
        }

        public bool put_XY(int x, int y) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_XY(handle_, x, y));
        }
        ...
        */
        public bool get_FrameRate(out uint nFrame, out uint nTime, out uint nTotalFrame) {
            ...
            return CheckHResult(Altaircam_get_FrameRate(handle_, out nFrame, out nTime, out nTotalFrame));
        }

        public bool LevelRangeAuto() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_LevelRangeAuto(handle_));
        }
        ...
        public bool AwbOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_AwbOnce(handle_, IntPtr.Zero, IntPtr.Zero));
        }
        ...
        public bool AwbInit() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_AwbInit(handle_, IntPtr.Zero, IntPtr.Zero));
        }

        public bool AbbOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_AbbOnce(handle_, IntPtr.Zero, IntPtr.Zero));
        }
        ...
        public bool FfcOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_FfcOnce(handle_));
        }
        ...
        public bool DfcOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_DfcOnce(handle_));
        }
        ...
        public bool FpncOnce() {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_FpncOnce(handle_));
        }

        public bool FfcExport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_FfcExport(handle_, filePath));
        }

        public bool FfcImport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_FfcImport(handle_, filePath));
        }

        public bool DfcExport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_DfcExport(handle_, filePath));
        }

        public bool DfcImport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_DfcImport(handle_, filePath));
        }

        public bool FpncExport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_FpncExport(handle_, filePath));
        }

        public bool FpncImport(string filePath) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_FpncImport(handle_, filePath));
        }
        ...
        public bool IoControl(uint ioLine, eIoControType eType, int outVal, out int inVal) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_IoControl(handle_, ioLine, eType, outVal, out inVal));
        }
        ...
        public bool AAF(eAAF action, int outVal, out int inVal) {
            ...
            return CheckHResult(Altaircam_AAF(handle_, action, outVal, out inVal));
        }
        ...
        static private bool Ptr2LensInfo(ref LensInfo pInfo, IntPtr p) {
            ...
            p = IncIntPtr(p, sizeof(ushort));
            pInfo.lensType = Marshal.ReadByte(p);
            p = IncIntPtr(p, sizeof(byte));
            ...
            if (sizeFN >= 0) {
                ...
                if (sp != IntPtr.Zero) {
                    ...
                    for (int i = 0; i < sizeFN; ++i) {
                        pInfo.arrayFN[i] = Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(sp));
                        sp = IncIntPtr(sp, IntPtr.Size);
                    }
                }
            }

            p = IncIntPtr(p, IntPtr.Size);
            pInfo.lensName = Marshal.PtrToStringAnsi(Marshal.ReadIntPtr(p));
        ...
        public bool get_LensInfo(ref LensInfo pInfo) {
            ...
            if (!CheckHResult(Altaircam_get_LensInfo(handle_, p))) {
        ...
        public bool get_AFState(ref AFState pState) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_AFState(handle_, ref pState));
        }

        public bool put_AFMode(eAFMode mode) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AFMode(handle_, mode));
        }

        public bool put_AFRoi(uint xOffset, uint yOffset, uint xWidth, uint yHeight) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AFRoi(handle_, xOffset, yOffset, xWidth, yHeight));
        }

        public bool put_AFAperture(int iAperture) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AFAperture(handle_, iAperture));
        }

        public bool put_AFFMPos(int iFMPos) {
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_put_AFFMPos(handle_, iFMPos));
        }
        ...
        public bool get_FocusMotor(out FocusMotor pFocusMotor) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Altaircam_get_FocusMotor(handle_, out pFocusMotor));
        }
        ...
        public bool GetHistogram(DelegateHistogramCallback funHistogram) {
            ...
            return CheckHResult(Altaircam_GetHistogram(handle_, pHistogramV1_, id_));
        }
        ...
        public bool GetHistogramV2(DelegateHistogramCallbackV2 funHistogramV2) {
            ...
            return CheckHResult(Altaircam_GetHistogramV2(handle_, pHistogramV2_, id_));
        }
        ...
        */
        ...
        public static double calcClarityFactorV2(IntPtr pImageData, int bits, uint nImgWidth, uint nImgHeight, uint xOffset, uint yOffset, uint xWidth, uint yHeight) {
            return Altaircam_calc_ClarityFactorV2(pImageData, bits, nImgWidth, nImgHeight, xOffset, yOffset, xWidth, yHeight);
        }
        ...
        */
        public static int Update(string camId, string filePath, DelegateProgress funProgress) {
            ...
            int ret = Altaircam_Update(camId, filePath, pProgress, id);
        ...
        public static ModelV2 getModel(ushort idVendor, ushort idProduct) {
            return toModelV2(Altaircam_get_Model(idVendor, idProduct));
        }
        ...
        public static int Gain2TempTint(int[] gain, out int temp, out int tint) {
            ...
            return Altaircam_Gain2TempTint(gain, out temp, out tint);
        }

        public static void TempTint2Gain(int temp, int tint, int[] gain) {
            Altaircam_TempTint2Gain(temp, tint, gain);
        }

        public static ModelV2[] allModel() {
            List<ModelV2> a = new List<ModelV2>();
            IntPtr q, p = Altaircam_all_Model();
            do {
        ...
        public static string PixelFormatName(ePIXELFORMAT pixelFormat) {
            IntPtr ptr = Altaircam_get_PixelFormatName(pixelFormat);
            if (IntPtr.Zero == ptr)
                return null;
...
#if LINUX
    private const string dll = "libaltaircam.so";
    private const UnmanagedType ut = UnmanagedType.LPStr;
        ...
        private static extern uint Altaircam_Enum(IntPtr ptr);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Altaircam_EnumV2(IntPtr ptr);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Altaircam_EnumWithName(IntPtr ptr);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern SafeCamHandle Altaircam_Open([MarshalAs(ut)] string camId);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
...
#endif
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_StartPullModeWithCallback(SafeCamHandle h, EVENT_CALLBACK funEvent, IntPtr ctxEvent);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_PullImageV4(SafeCamHandle h, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_PullImageV4(SafeCamHandle h, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_PullImageV4(SafeCamHandle h, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_WaitImageV4(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_WaitImageV4(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_WaitImageV4(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_PullImageV3(SafeCamHandle h, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageV3(SafeCamHandle h, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageV3(SafeCamHandle h, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_WaitImageV3(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_WaitImageV3(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_WaitImageV3(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImage(SafeCamHandle h, byte[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImage(SafeCamHandle h, ushort[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImage(SafeCamHandle h, byte[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImage(SafeCamHandle h, ushort[] pImageData, int bits, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageWithRowPitch(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageWithRowPitch(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageWithRowPitch(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageWithRowPitch(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageV2(SafeCamHandle h, IntPtr pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageV2(SafeCamHandle h, byte[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageV2(SafeCamHandle h, ushort[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageV2(SafeCamHandle h, IntPtr pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageV2(SafeCamHandle h, byte[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageV2(SafeCamHandle h, ushort[] pImageData, int bits, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageWithRowPitchV2(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullImageWithRowPitchV2(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageWithRowPitchV2(SafeCamHandle h, byte[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_PullStillImageWithRowPitchV2(SafeCamHandle h, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_StartPushModeV4(SafeCamHandle h, DATA_CALLBACK_V4 funData, IntPtr ctxData, EVENT_CALLBACK funEvent, IntPtr ctxEvent);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_StartPushModeV3(SafeCamHandle h, DATA_CALLBACK_V3 funData, IntPtr ctxData, EVENT_CALLBACK funEvent, IntPtr ctxEvent);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_SnapR(SafeCamHandle h, uint nResolutionIndex, uint nNumber);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_Trigger(SafeCamHandle h, ushort nNumber);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_TriggerSyncV4(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_TriggerSyncV4(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_TriggerSyncV4(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_TriggerSync(SafeCamHandle h, uint nWaitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_TriggerSync(SafeCamHandle h, uint nWaitMS, byte[] pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
        private static extern int Altaircam_TriggerSync(SafeCamHandle h, uint nWaitMS, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_Resolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth, out int pHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_ResolutionRatio(SafeCamHandle h, uint nResolutionIndex, out int pNumerator, out int pDenominator);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Altaircam_get_Field(SafeCamHandle h);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_RawFormat(SafeCamHandle h, out uint nFourCC, out uint bitdepth);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_RoiN(SafeCamHandle h, uint[] xoffset, uint[] yoffset, uint[] xWidth, uint[] yHeight, uint Num);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_XY(SafeCamHandle h, int x, int y);
        ...
        */
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_AutoExpoRange(SafeCamHandle h, uint maxTime, uint minTime, ushort maxGain, ushort minGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_AutoExpoRange(SafeCamHandle h, out uint maxTime, out uint minTime, out ushort maxGain, out ushort minGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_MaxAutoExpoTimeAGain(SafeCamHandle h, uint maxTime, ushort maxGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_MaxAutoExpoTimeAGain(SafeCamHandle h, out uint maxTime, out ushort maxGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_MinAutoExpoTimeAGain(SafeCamHandle h, uint minTime, ushort minGain);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_MinAutoExpoTimeAGain(SafeCamHandle h, out uint minTime, out ushort minGain);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_RealExpoTime(SafeCamHandle h, out uint Time)/* actual exposure time */;
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_ExpTimeRange(SafeCamHandle h, out uint nMin, out uint nMax, out uint nDef);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_ExpoAGain(SafeCamHandle h, out ushort Gain);/* percent, such as 300 */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_ExpoAGain(SafeCamHandle h, ushort Gain);/* percent */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Altaircam_get_MaxBitDepth(SafeCamHandle h);/* get the max bitdepth of this camera, such as 8, 10, 12, 14, 16 */
        ...
        */
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_AwbOnce(SafeCamHandle h, IntPtr funTT, IntPtr ctxTT);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_AwbInit(SafeCamHandle h, IntPtr funWB, IntPtr ctxWB);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_LevelRangeAuto(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACKV1 funHistogramV1, IntPtr ctxHistogramV1);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_GetHistogramV2(SafeCamHandle h, HISTOGRAM_CALLBACKV2 funHistogramV2, IntPtr ctxHistogramV2);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_AbbOnce(SafeCamHandle h, IntPtr funBB, IntPtr ctxBB);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_write_EEPROM(SafeCamHandle h, uint addr, byte[] pBuffer, int nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_read_EEPROM(SafeCamHandle h, uint addr, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_read_EEPROM(SafeCamHandle h, uint addr, byte[] pBuffer, int nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_rwc_Flash(SafeCamHandle h, uint action, uint addr, uint len, IntPtr pData);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_rwc_Flash(SafeCamHandle h, uint action, uint addr, uint len, byte[] pData);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_write_Pipe(SafeCamHandle h, uint pipeId, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_read_Pipe(SafeCamHandle h, uint pipeId, IntPtr pBuffer, uint nBufferLen);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_feed_Pipe(SafeCamHandle h, uint pipeId);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_PixelFormatSupport(SafeCamHandle h, sbyte cmd, out int iValue);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern IntPtr Altaircam_get_PixelFormatName(ePIXELFORMAT val);
        ...
        */
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_Binning(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string Value, [MarshalAs(UnmanagedType.LPStr)] string Method);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_Binning(SafeCamHandle h, out IntPtr Value, out IntPtr Method);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_BinningNumber(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_BinningValue(SafeCamHandle h, uint index, out IntPtr Value);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_BinningMethod(SafeCamHandle h, uint index, out IntPtr Value);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_SelfTrigger(SafeCamHandle h, ref SelfTrigger pSt);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_SelfTrigger(SafeCamHandle h, ref SelfTrigger pSt);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_FpncOnce(SafeCamHandle h);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_FpncExport(SafeCamHandle h, [MarshalAs(ut)] string filePath);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_FpncImport(SafeCamHandle h, [MarshalAs(ut)] string filePath);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_IoControl(SafeCamHandle h, uint ioLine, eIoControType eType, int outVal, out int inVal);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_AAF(SafeCamHandle h, eAAF action, int outVal, out int inVal);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_LensInfo(SafeCamHandle h, IntPtr pInfo);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_AFState(SafeCamHandle h, ref AFState pState);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_AFMode(SafeCamHandle h, eAFMode mode);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_AFRoi(SafeCamHandle h, uint xOffset, uint yOffset, uint xWidth, uint yHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_AFAperture(SafeCamHandle h, int iAperture);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_put_AFFMPos(SafeCamHandle h, int iFMPos);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_get_FocusMotor(SafeCamHandle h, out FocusMotor pFocusMotor);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern double Altaircam_calc_ClarityFactor(IntPtr pImageData, int bits, uint nImgWidth, uint nImgHeight);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern double Altaircam_calc_ClarityFactorV2(IntPtr pImageData, int bits, uint nImgWidth, uint nImgHeight, uint xOffset, uint yOffset, uint xWidth, uint yHeight);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_Replug([MarshalAs(ut)] string camId);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_Update([MarshalAs(ut)] string camId, [MarshalAs(ut)] string filePath, PROGRESS_CALLBACK funProgress, IntPtr ctxProgress);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_GigeEnable(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern IntPtr Altaircam_get_Model(ushort idVendor, ushort idProduct);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern IntPtr Altaircam_all_Model();

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Altaircam_Gain2TempTint(int[] gain, out int temp, out int tint);
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern void Altaircam_TempTint2Gain(int temp, int tint, [Out] int[] gain);
    }
}